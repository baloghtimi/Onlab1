...
import org.mondo.collaboration.security.increment.vocabulary.*;
...
public class VocabularyFactoryImpl extends EFactoryImpl implements VocabularyFactory {
	...
	public static VocabularyFactory init() {
		try {
			VocabularyFactory theVocabularyFactory = (VocabularyFactory) EPackage.Registry.INSTANCE
					.getEFactory(VocabularyPackage.eNS_URI);
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case VocabularyPackage.ACCESSIBILITY_LEVEL:
			return createAccessibilityLevelFromString(eDataType, initialValue);
		case VocabularyPackage.OPERATION_TYPE:
