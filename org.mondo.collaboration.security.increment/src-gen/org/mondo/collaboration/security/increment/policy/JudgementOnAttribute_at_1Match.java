...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.judgementOnAttribute_at_1 pattern,
 * to be used in conjunction with {@link JudgementOnAttribute_at_1Matcher}.
 * 
...
public abstract class JudgementOnAttribute_at_1Match extends BasePatternMatch {
  ...
  private JudgementOnAttribute_at_1Match(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return JudgementOnAttribute_at_1Match.parameterNames;
  }
  ...
  @Override
  public JudgementOnAttribute_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof JudgementOnAttribute_at_1Match)) {
        JudgementOnAttribute_at_1Match other = (JudgementOnAttribute_at_1Match) obj;
  ...
  @Override
  public JudgementOnAttribute_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JudgementOnAttribute_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static JudgementOnAttribute_at_1Match newMutableMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static JudgementOnAttribute_at_1Match newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
  
  private static final class Mutable extends JudgementOnAttribute_at_1Match {
  ...
  private static final class Immutable extends JudgementOnAttribute_at_1Match {
