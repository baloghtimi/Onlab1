...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.judgementOnReference_at_default pattern,
 * to be used in conjunction with {@link JudgementOnReference_at_defaultMatcher}.
 * 
...
public abstract class JudgementOnReference_at_defaultMatch extends BasePatternMatch {
  ...
  private JudgementOnReference_at_defaultMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return JudgementOnReference_at_defaultMatch.parameterNames;
  }
  ...
  @Override
  public JudgementOnReference_at_defaultMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof JudgementOnReference_at_defaultMatch)) {
        JudgementOnReference_at_defaultMatch other = (JudgementOnReference_at_defaultMatch) obj;
  ...
  @Override
  public JudgementOnReference_at_defaultQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JudgementOnReference_at_defaultMatch newEmptyMatch() {
   ...
   * 
   */
  public static JudgementOnReference_at_defaultMatch newMutableMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static JudgementOnReference_at_defaultMatch newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pTarget, pReference, pOperation, pAccess);
  }
  
  private static final class Mutable extends JudgementOnReference_at_defaultMatch {
  ...
  private static final class Immutable extends JudgementOnReference_at_defaultMatch {
