...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.dominatedExplicitJudgementOnAttribute_at_0 pattern,
 * to be used in conjunction with {@link DominatedExplicitJudgementOnAttribute_at_0Matcher}.
 * 
...
public abstract class DominatedExplicitJudgementOnAttribute_at_0Match extends BasePatternMatch {
  ...
  private DominatedExplicitJudgementOnAttribute_at_0Match(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return DominatedExplicitJudgementOnAttribute_at_0Match.parameterNames;
  }
  ...
  @Override
  public DominatedExplicitJudgementOnAttribute_at_0Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof DominatedExplicitJudgementOnAttribute_at_0Match)) {
        DominatedExplicitJudgementOnAttribute_at_0Match other = (DominatedExplicitJudgementOnAttribute_at_0Match) obj;
  ...
  @Override
  public DominatedExplicitJudgementOnAttribute_at_0QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static DominatedExplicitJudgementOnAttribute_at_0Match newEmptyMatch() {
   ...
   * 
   */
  public static DominatedExplicitJudgementOnAttribute_at_0Match newMutableMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
   ...
   * 
   */
  public static DominatedExplicitJudgementOnAttribute_at_0Match newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
    return new Immutable(pUser, pSource, pValue, pAttribute, pOperation, pPrevailingAccess);
  }
  
  private static final class Mutable extends DominatedExplicitJudgementOnAttribute_at_0Match {
  ...
  private static final class Immutable extends DominatedExplicitJudgementOnAttribute_at_0Match {
