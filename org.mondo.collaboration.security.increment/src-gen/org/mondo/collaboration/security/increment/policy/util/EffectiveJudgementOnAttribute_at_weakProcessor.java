...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnAttribute_at_weak pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class EffectiveJudgementOnAttribute_at_weakProcessor implements IMatchProcessor<EffectiveJudgementOnAttribute_at_weakMatch> {
  /**
  ...
  @Override
  public void process(final EffectiveJudgementOnAttribute_at_weakMatch match) {
