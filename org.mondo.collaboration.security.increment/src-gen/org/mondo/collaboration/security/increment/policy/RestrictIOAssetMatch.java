...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.restrictIOAsset pattern,
 * to be used in conjunction with {@link RestrictIOAssetMatcher}.
 * 
...
public abstract class RestrictIOAssetMatch extends BasePatternMatch {
  private EObject fObject;
  
  private static List<String> parameterNames = makeImmutableList("object");
  
  private RestrictIOAssetMatch(final EObject pObject) {
  ...
  public List<String> parameterNames() {
    return RestrictIOAssetMatch.parameterNames;
  }
  ...
  @Override
  public RestrictIOAssetMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof RestrictIOAssetMatch)) {
        RestrictIOAssetMatch other = (RestrictIOAssetMatch) obj;
  ...
  @Override
  public RestrictIOAssetQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static RestrictIOAssetMatch newEmptyMatch() {
   ...
   * 
   */
  public static RestrictIOAssetMatch newMutableMatch(final EObject pObject) {
   ...
   * 
   */
  public static RestrictIOAssetMatch newMatch(final EObject pObject) {
    return new Immutable(pObject);
  }
  
  private static final class Mutable extends RestrictIOAssetMatch {
  ...
  private static final class Immutable extends RestrictIOAssetMatch {
