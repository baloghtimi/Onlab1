...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.objectAllObjects pattern,
 * to be used in conjunction with {@link ObjectAllObjectsMatcher}.
 * 
...
public abstract class ObjectAllObjectsMatch extends BasePatternMatch {
  private EObject fObject;
  
  private static List<String> parameterNames = makeImmutableList("object");
  
  private ObjectAllObjectsMatch(final EObject pObject) {
  ...
  public List<String> parameterNames() {
    return ObjectAllObjectsMatch.parameterNames;
  }
  ...
  @Override
  public ObjectAllObjectsMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof ObjectAllObjectsMatch)) {
        ObjectAllObjectsMatch other = (ObjectAllObjectsMatch) obj;
  ...
  @Override
  public ObjectAllObjectsQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ObjectAllObjectsMatch newEmptyMatch() {
   ...
   * 
   */
  public static ObjectAllObjectsMatch newMutableMatch(final EObject pObject) {
   ...
   * 
   */
  public static ObjectAllObjectsMatch newMatch(final EObject pObject) {
    return new Immutable(pObject);
  }
  
  private static final class Mutable extends ObjectAllObjectsMatch {
  ...
  private static final class Immutable extends ObjectAllObjectsMatch {
