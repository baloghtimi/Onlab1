...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.effectiveJudgement_at_0 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class EffectiveJudgement_at_0Processor implements IMatchProcessor<EffectiveJudgement_at_0Match> {
  /**
  ...
  @Override
  public void process(final EffectiveJudgement_at_0Match match) {
