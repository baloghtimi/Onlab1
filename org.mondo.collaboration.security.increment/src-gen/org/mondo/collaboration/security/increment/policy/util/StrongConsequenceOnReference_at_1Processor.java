...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.strongConsequenceOnReference_at_1 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class StrongConsequenceOnReference_at_1Processor implements IMatchProcessor<StrongConsequenceOnReference_at_1Match> {
  /**
  ...
  @Override
  public void process(final StrongConsequenceOnReference_at_1Match match) {
