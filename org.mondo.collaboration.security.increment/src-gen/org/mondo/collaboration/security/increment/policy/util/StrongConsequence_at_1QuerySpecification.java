...
/**
 * A pattern-specific query specification that can instantiate StrongConsequence_at_1Matcher in a type-safe way.
 * 
 * @see StrongConsequence_at_1Matcher
 * @see StrongConsequence_at_1Match
 * 
 */
@SuppressWarnings("all")
public final class StrongConsequence_at_1QuerySpecification extends BaseGeneratedEMFQuerySpecification<StrongConsequence_at_1Matcher> {
  private StrongConsequence_at_1QuerySpecification() {
   ...
   * 
   */
  public static StrongConsequence_at_1QuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected StrongConsequence_at_1Matcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return StrongConsequence_at_1Matcher.on(engine);
  }
  
  @Override
  public StrongConsequence_at_1Matcher instantiate() throws ViatraQueryException {
    return StrongConsequence_at_1Matcher.create();
  }
  
  @Override
  public StrongConsequence_at_1Match newEmptyMatch() {
    return StrongConsequence_at_1Match.newEmptyMatch();
  }
  
  @Override
  public StrongConsequence_at_1Match newMatch(final Object... parameters) {
    return StrongConsequence_at_1Match.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (org.mondo.collaboration.security.increment.vocabulary.OperationType) parameters[2], (org.mondo.collaboration.security.increment.vocabulary.AccessibilityLevel) parameters[3], (org.eclipse.emf.ecore.EObject) parameters[4], (org.mondo.collaboration.security.increment.vocabulary.OperationType) parameters[5], (org.mondo.collaboration.security.increment.vocabulary.AccessibilityLevel) parameters[6]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.StrongConsequence_at_1QuerySpecification (visibility: PUBLIC, simpleName: StrongConsequence_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.StrongConsequence_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.StrongConsequence_at_1QuerySpecification (visibility: PUBLIC, simpleName: StrongConsequence_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.StrongConsequence_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static StrongConsequence_at_1QuerySpecification INSTANCE = new StrongConsequence_at_1QuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static StrongConsequence_at_1QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.security.increment.policy.strongConsequence_at_1";
    }
      ...
      try {
          {
              ...
              // 	// type II, read vs write	find effectiveJudgement_at_1(user, domAsset, domOp, domAccess)
              new PositivePatternCall(body, new FlatTuple(var_user, var_domAsset, var_domOp, var_domAccess), EffectiveJudgement_at_1QuerySpecification.instance().getInternalQueryRepresentation());
              // 	depAsset == domAsset
          ...
          }
          {
              ...
              // 	// type III, read vs containment	find effectiveJudgement_at_1(user, domAsset, domOp, domAccess)
              new PositivePatternCall(body, new FlatTuple(var_user, var_domAsset, var_domOp, var_domAccess), EffectiveJudgement_at_1QuerySpecification.instance().getInternalQueryRepresentation());
