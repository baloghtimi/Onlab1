...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.strongConsequenceOnAttribute_at_1 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class StrongConsequenceOnAttribute_at_1Processor implements IMatchProcessor<StrongConsequenceOnAttribute_at_1Match> {
  /**
  ...
  @Override
  public void process(final StrongConsequenceOnAttribute_at_1Match match) {
