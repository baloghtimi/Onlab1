...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.objectIO pattern,
 * to be used in conjunction with {@link ObjectIOMatcher}.
 * 
...
public abstract class ObjectIOMatch extends BasePatternMatch {
  private EObject fObject;
  
  private static List<String> parameterNames = makeImmutableList("object");
  
  private ObjectIOMatch(final EObject pObject) {
  ...
  public List<String> parameterNames() {
    return ObjectIOMatch.parameterNames;
  }
  ...
  @Override
  public ObjectIOMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof ObjectIOMatch)) {
        ObjectIOMatch other = (ObjectIOMatch) obj;
  ...
  @Override
  public ObjectIOQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ObjectIOMatch newEmptyMatch() {
   ...
   * 
   */
  public static ObjectIOMatch newMutableMatch(final EObject pObject) {
   ...
   * 
   */
  public static ObjectIOMatch newMatch(final EObject pObject) {
    return new Immutable(pObject);
  }
  
  private static final class Mutable extends ObjectIOMatch {
  ...
  private static final class Immutable extends ObjectIOMatch {
