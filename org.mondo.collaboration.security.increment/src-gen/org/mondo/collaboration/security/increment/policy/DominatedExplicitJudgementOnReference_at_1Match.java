...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.dominatedExplicitJudgementOnReference_at_1 pattern,
 * to be used in conjunction with {@link DominatedExplicitJudgementOnReference_at_1Matcher}.
 * 
...
public abstract class DominatedExplicitJudgementOnReference_at_1Match extends BasePatternMatch {
  ...
  private DominatedExplicitJudgementOnReference_at_1Match(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return DominatedExplicitJudgementOnReference_at_1Match.parameterNames;
  }
  ...
  @Override
  public DominatedExplicitJudgementOnReference_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof DominatedExplicitJudgementOnReference_at_1Match)) {
        DominatedExplicitJudgementOnReference_at_1Match other = (DominatedExplicitJudgementOnReference_at_1Match) obj;
  ...
  @Override
  public DominatedExplicitJudgementOnReference_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static DominatedExplicitJudgementOnReference_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static DominatedExplicitJudgementOnReference_at_1Match newMutableMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
   ...
   * 
   */
  public static DominatedExplicitJudgementOnReference_at_1Match newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
    return new Immutable(pUser, pSource, pTarget, pReference, pOperation, pPrevailingAccess);
  }
  
  private static final class Mutable extends DominatedExplicitJudgementOnReference_at_1Match {
  ...
  private static final class Immutable extends DominatedExplicitJudgementOnReference_at_1Match {
