...
/**
 * A pattern-specific query specification that can instantiate DominatedExplicitJudgementOnAttribute_at_1Matcher in a type-safe way.
 * 
...
public final class DominatedExplicitJudgementOnAttribute_at_1QuerySpecification extends BaseGeneratedEMFQuerySpecification<DominatedExplicitJudgementOnAttribute_at_1Matcher> {
  private DominatedExplicitJudgementOnAttribute_at_1QuerySpecification() {
   ...
   * 
   */
  public static DominatedExplicitJudgementOnAttribute_at_1QuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected DominatedExplicitJudgementOnAttribute_at_1Matcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return DominatedExplicitJudgementOnAttribute_at_1Matcher.on(engine);
  }
  
  @Override
  public DominatedExplicitJudgementOnAttribute_at_1Matcher instantiate() throws ViatraQueryException {
    return DominatedExplicitJudgementOnAttribute_at_1Matcher.create();
  }
  
  @Override
  public DominatedExplicitJudgementOnAttribute_at_1Match newEmptyMatch() {
    return DominatedExplicitJudgementOnAttribute_at_1Match.newEmptyMatch();
  }
  
  @Override
  public DominatedExplicitJudgementOnAttribute_at_1Match newMatch(final Object... parameters) {
    return DominatedExplicitJudgementOnAttribute_at_1Match.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (java.lang.Object) parameters[2], (org.eclipse.emf.ecore.EAttribute) parameters[3], (org.mondo.collaboration.policy.rules.OperationType) parameters[4], (org.mondo.collaboration.policy.rules.AccessibilityLevel) parameters[5]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnAttribute_at_1QuerySpecification (visibility: PUBLIC, simpleName: DominatedExplicitJudgementOnAttribute_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnAttribute_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnAttribute_at_1QuerySpecification (visibility: PUBLIC, simpleName: DominatedExplicitJudgementOnAttribute_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnAttribute_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static DominatedExplicitJudgementOnAttribute_at_1QuerySpecification INSTANCE = new DominatedExplicitJudgementOnAttribute_at_1QuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static DominatedExplicitJudgementOnAttribute_at_1QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
