...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.dominatedExplicitJudgementOnReference_at_0 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class DominatedExplicitJudgementOnReference_at_0Processor implements IMatchProcessor<DominatedExplicitJudgementOnReference_at_0Match> {
  /**
  ...
  @Override
  public void process(final DominatedExplicitJudgementOnReference_at_0Match match) {
