...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.judgementOnAttribute_at_1 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link JudgementOnAttribute_at_1Match}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 *  @see JudgementOnAttribute_at_1Processor
 * @see JudgementOnAttribute_at_1QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class JudgementOnAttribute_at_1Matcher extends BaseMatcher<JudgementOnAttribute_at_1Match> {
  /**
   ...
   * 
   */
  public static JudgementOnAttribute_at_1Matcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    JudgementOnAttribute_at_1Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (JudgementOnAttribute_at_1Matcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static JudgementOnAttribute_at_1Matcher create() throws ViatraQueryException {
    return new JudgementOnAttribute_at_1Matcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(JudgementOnAttribute_at_1Matcher.class);
   ...
   * 
   */
  private JudgementOnAttribute_at_1Matcher() throws ViatraQueryException {
   ...
   * @return matches represented as a JudgementOnAttribute_at_1Match object.
   * 
   */
  public Collection<JudgementOnAttribute_at_1Match> getAllMatches(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a JudgementOnAttribute_at_1Match object, or null if no match is found.
   * 
   */
  public JudgementOnAttribute_at_1Match getOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super JudgementOnAttribute_at_1Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super JudgementOnAttribute_at_1Match> processor) {
   ...
   * 
   */
  public JudgementOnAttribute_at_1Match newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return JudgementOnAttribute_at_1Match.newMatch(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final JudgementOnAttribute_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfsource(final JudgementOnAttribute_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfvalue(final JudgementOnAttribute_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EAttribute> getAllValuesOfattribute(final JudgementOnAttribute_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfoperation(final JudgementOnAttribute_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfaccess(final JudgementOnAttribute_at_1Match partialMatch) {
  ...
  @Override
  protected JudgementOnAttribute_at_1Match tupleToMatch(final Tuple t) {
    try {
        return JudgementOnAttribute_at_1Match.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_SOURCE), (Object) t.get(POSITION_VALUE), (EAttribute) t.get(POSITION_ATTRIBUTE), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_ACCESS));
  ...
  @Override
  protected JudgementOnAttribute_at_1Match arrayToMatch(final Object[] match) {
    try {
        return JudgementOnAttribute_at_1Match.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected JudgementOnAttribute_at_1Match arrayToMatchMutable(final Object[] match) {
    try {
        return JudgementOnAttribute_at_1Match.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<JudgementOnAttribute_at_1Matcher> querySpecification() throws ViatraQueryException {
