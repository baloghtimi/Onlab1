...
/**
 * A pattern-specific query specification that can instantiate Judgement_at_1Matcher in a type-safe way.
 * 
 * @see Judgement_at_1Matcher
 * @see Judgement_at_1Match
 * 
 */
@SuppressWarnings("all")
public final class Judgement_at_1QuerySpecification extends BaseGeneratedEMFQuerySpecification<Judgement_at_1Matcher> {
  private Judgement_at_1QuerySpecification() {
   ...
   * 
   */
  public static Judgement_at_1QuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected Judgement_at_1Matcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return Judgement_at_1Matcher.on(engine);
  }
  
  @Override
  public Judgement_at_1Matcher instantiate() throws ViatraQueryException {
    return Judgement_at_1Matcher.create();
  }
  
  @Override
  public Judgement_at_1Match newEmptyMatch() {
    return Judgement_at_1Match.newEmptyMatch();
  }
  
  @Override
  public Judgement_at_1Match newMatch(final Object... parameters) {
    return Judgement_at_1Match.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (org.mondo.collaboration.security.increment.vocabulary.OperationType) parameters[2], (org.mondo.collaboration.security.increment.vocabulary.AccessibilityLevel) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.Judgement_at_1QuerySpecification (visibility: PUBLIC, simpleName: Judgement_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.Judgement_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.Judgement_at_1QuerySpecification (visibility: PUBLIC, simpleName: Judgement_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.Judgement_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Judgement_at_1QuerySpecification INSTANCE = new Judgement_at_1QuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Judgement_at_1QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.security.increment.policy.judgement_at_1";
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
          ...
          }
          {
              ...
              new PositivePatternCall(body, new FlatTuple(var_user, var_asset, var_operation, var_access, var__domAsset, var__domOp, var__domAccess), StrongConsequence_at_1QuerySpecification.instance().getInternalQueryRepresentation());
              bodies.add(body);
          }
