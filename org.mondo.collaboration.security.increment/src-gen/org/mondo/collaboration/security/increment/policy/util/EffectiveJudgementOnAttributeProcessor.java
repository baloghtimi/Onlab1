...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnAttribute pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class EffectiveJudgementOnAttributeProcessor implements IMatchProcessor<EffectiveJudgementOnAttributeMatch> {
  /**
  ...
  @Override
  public void process(final EffectiveJudgementOnAttributeMatch match) {
