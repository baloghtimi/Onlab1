...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnAttribute_at_weak pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link EffectiveJudgementOnAttribute_at_weakMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 *  @see EffectiveJudgementOnAttribute_at_weakProcessor
 * @see EffectiveJudgementOnAttribute_at_weakQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class EffectiveJudgementOnAttribute_at_weakMatcher extends BaseMatcher<EffectiveJudgementOnAttribute_at_weakMatch> {
  /**
   ...
   * 
   */
  public static EffectiveJudgementOnAttribute_at_weakMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    EffectiveJudgementOnAttribute_at_weakMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (EffectiveJudgementOnAttribute_at_weakMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static EffectiveJudgementOnAttribute_at_weakMatcher create() throws ViatraQueryException {
    return new EffectiveJudgementOnAttribute_at_weakMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EffectiveJudgementOnAttribute_at_weakMatcher.class);
   ...
   * 
   */
  private EffectiveJudgementOnAttribute_at_weakMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a EffectiveJudgementOnAttribute_at_weakMatch object.
   * 
   */
  public Collection<EffectiveJudgementOnAttribute_at_weakMatch> getAllMatches(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a EffectiveJudgementOnAttribute_at_weakMatch object, or null if no match is found.
   * 
   */
  public EffectiveJudgementOnAttribute_at_weakMatch getOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super EffectiveJudgementOnAttribute_at_weakMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super EffectiveJudgementOnAttribute_at_weakMatch> processor) {
   ...
   * 
   */
  public EffectiveJudgementOnAttribute_at_weakMatch newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return EffectiveJudgementOnAttribute_at_weakMatch.newMatch(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final EffectiveJudgementOnAttribute_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfsource(final EffectiveJudgementOnAttribute_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfvalue(final EffectiveJudgementOnAttribute_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<EAttribute> getAllValuesOfattribute(final EffectiveJudgementOnAttribute_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfoperation(final EffectiveJudgementOnAttribute_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfaccess(final EffectiveJudgementOnAttribute_at_weakMatch partialMatch) {
  ...
  @Override
  protected EffectiveJudgementOnAttribute_at_weakMatch tupleToMatch(final Tuple t) {
    try {
        return EffectiveJudgementOnAttribute_at_weakMatch.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_SOURCE), (Object) t.get(POSITION_VALUE), (EAttribute) t.get(POSITION_ATTRIBUTE), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_ACCESS));
  ...
  @Override
  protected EffectiveJudgementOnAttribute_at_weakMatch arrayToMatch(final Object[] match) {
    try {
        return EffectiveJudgementOnAttribute_at_weakMatch.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected EffectiveJudgementOnAttribute_at_weakMatch arrayToMatchMutable(final Object[] match) {
    try {
        return EffectiveJudgementOnAttribute_at_weakMatch.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<EffectiveJudgementOnAttribute_at_weakMatcher> querySpecification() throws ViatraQueryException {
