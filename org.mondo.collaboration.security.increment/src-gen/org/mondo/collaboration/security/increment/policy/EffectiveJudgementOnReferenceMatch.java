...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnReference pattern,
 * to be used in conjunction with {@link EffectiveJudgementOnReferenceMatcher}.
 * 
...
public abstract class EffectiveJudgementOnReferenceMatch extends BasePatternMatch {
  ...
  private EffectiveJudgementOnReferenceMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return EffectiveJudgementOnReferenceMatch.parameterNames;
  }
  ...
  @Override
  public EffectiveJudgementOnReferenceMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof EffectiveJudgementOnReferenceMatch)) {
        EffectiveJudgementOnReferenceMatch other = (EffectiveJudgementOnReferenceMatch) obj;
  ...
  @Override
  public EffectiveJudgementOnReferenceQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EffectiveJudgementOnReferenceMatch newEmptyMatch() {
   ...
   * 
   */
  public static EffectiveJudgementOnReferenceMatch newMutableMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static EffectiveJudgementOnReferenceMatch newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pTarget, pReference, pOperation, pAccess);
  }
  
  private static final class Mutable extends EffectiveJudgementOnReferenceMatch {
  ...
  private static final class Immutable extends EffectiveJudgementOnReferenceMatch {
