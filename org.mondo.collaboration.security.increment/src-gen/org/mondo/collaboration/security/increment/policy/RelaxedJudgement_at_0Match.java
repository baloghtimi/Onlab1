...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.relaxedJudgement_at_0 pattern,
 * to be used in conjunction with {@link RelaxedJudgement_at_0Matcher}.
 * 
...
public abstract class RelaxedJudgement_at_0Match extends BasePatternMatch {
  ...
  private RelaxedJudgement_at_0Match(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
    this.fAsset = pAsset;
  ...
  public List<String> parameterNames() {
    return RelaxedJudgement_at_0Match.parameterNames;
  }
  ...
  @Override
  public RelaxedJudgement_at_0Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof RelaxedJudgement_at_0Match)) {
        RelaxedJudgement_at_0Match other = (RelaxedJudgement_at_0Match) obj;
  ...
  @Override
  public RelaxedJudgement_at_0QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static RelaxedJudgement_at_0Match newEmptyMatch() {
   ...
   * 
   */
  public static RelaxedJudgement_at_0Match newMutableMatch(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static RelaxedJudgement_at_0Match newMatch(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pAsset, pOperation, pAccess);
  }
  
  private static final class Mutable extends RelaxedJudgement_at_0Match {
  ...
  private static final class Immutable extends RelaxedJudgement_at_0Match {
