...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.strongConsequenceOnReference_at_1 pattern,
 * to be used in conjunction with {@link StrongConsequenceOnReference_at_1Matcher}.
 * 
 ...
 *  @see StrongConsequenceOnReference_at_1Processor
 * 
 */
@SuppressWarnings("all")
public abstract class StrongConsequenceOnReference_at_1Match extends BasePatternMatch {
  ...
  private StrongConsequenceOnReference_at_1Match(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return StrongConsequenceOnReference_at_1Match.parameterNames;
  }
  ...
  @Override
  public StrongConsequenceOnReference_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof StrongConsequenceOnReference_at_1Match)) {
        StrongConsequenceOnReference_at_1Match other = (StrongConsequenceOnReference_at_1Match) obj;
  ...
  @Override
  public StrongConsequenceOnReference_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static StrongConsequenceOnReference_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static StrongConsequenceOnReference_at_1Match newMutableMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static StrongConsequenceOnReference_at_1Match newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pTarget, pReference, pOperation, pAccess);
  }
  
  private static final class Mutable extends StrongConsequenceOnReference_at_1Match {
  ...
  private static final class Immutable extends StrongConsequenceOnReference_at_1Match {
