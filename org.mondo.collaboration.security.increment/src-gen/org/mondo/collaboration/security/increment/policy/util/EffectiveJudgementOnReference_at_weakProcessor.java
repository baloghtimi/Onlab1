...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnReference_at_weak pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class EffectiveJudgementOnReference_at_weakProcessor implements IMatchProcessor<EffectiveJudgementOnReference_at_weakMatch> {
  /**
  ...
  @Override
  public void process(final EffectiveJudgementOnReference_at_weakMatch match) {
