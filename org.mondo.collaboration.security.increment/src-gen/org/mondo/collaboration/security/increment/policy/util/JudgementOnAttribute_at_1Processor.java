...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.judgementOnAttribute_at_1 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class JudgementOnAttribute_at_1Processor implements IMatchProcessor<JudgementOnAttribute_at_1Match> {
  /**
  ...
  @Override
  public void process(final JudgementOnAttribute_at_1Match match) {
