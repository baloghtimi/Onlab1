...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnAttribute_at_1 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class EffectiveJudgementOnAttribute_at_1Processor implements IMatchProcessor<EffectiveJudgementOnAttribute_at_1Match> {
  /**
  ...
  @Override
  public void process(final EffectiveJudgementOnAttribute_at_1Match match) {
