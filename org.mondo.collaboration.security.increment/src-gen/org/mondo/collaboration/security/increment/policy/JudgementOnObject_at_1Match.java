...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.judgementOnObject_at_1 pattern,
 * to be used in conjunction with {@link JudgementOnObject_at_1Matcher}.
 * 
 ...
 * 
 * @see JudgementOnObject_at_1Matcher
 *  @see JudgementOnObject_at_1Processor
 * 
 */
@SuppressWarnings("all")
public abstract class JudgementOnObject_at_1Match extends BasePatternMatch {
  ...
  private JudgementOnObject_at_1Match(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public String patternName() {
    return "org.mondo.collaboration.security.increment.policy.judgementOnObject_at_1";
  }
  
  @Override
  public List<String> parameterNames() {
    return JudgementOnObject_at_1Match.parameterNames;
  }
  ...
  @Override
  public JudgementOnObject_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof JudgementOnObject_at_1Match)) {
        JudgementOnObject_at_1Match other = (JudgementOnObject_at_1Match) obj;
  ...
  @Override
  public JudgementOnObject_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JudgementOnObject_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static JudgementOnObject_at_1Match newMutableMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static JudgementOnObject_at_1Match newMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pObject, pOperation, pAccess);
  }
  
  private static final class Mutable extends JudgementOnObject_at_1Match {
  ...
  private static final class Immutable extends JudgementOnObject_at_1Match {
