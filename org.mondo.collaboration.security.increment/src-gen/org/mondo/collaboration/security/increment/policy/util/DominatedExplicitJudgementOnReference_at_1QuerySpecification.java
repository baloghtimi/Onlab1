...
/**
 * A pattern-specific query specification that can instantiate DominatedExplicitJudgementOnReference_at_1Matcher in a type-safe way.
 * 
 * @see DominatedExplicitJudgementOnReference_at_1Matcher
 * @see DominatedExplicitJudgementOnReference_at_1Match
 * 
 */
@SuppressWarnings("all")
public final class DominatedExplicitJudgementOnReference_at_1QuerySpecification extends BaseGeneratedEMFQuerySpecification<DominatedExplicitJudgementOnReference_at_1Matcher> {
  private DominatedExplicitJudgementOnReference_at_1QuerySpecification() {
   ...
   * 
   */
  public static DominatedExplicitJudgementOnReference_at_1QuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected DominatedExplicitJudgementOnReference_at_1Matcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return DominatedExplicitJudgementOnReference_at_1Matcher.on(engine);
  }
  
  @Override
  public DominatedExplicitJudgementOnReference_at_1Matcher instantiate() throws ViatraQueryException {
    return DominatedExplicitJudgementOnReference_at_1Matcher.create();
  }
  
  @Override
  public DominatedExplicitJudgementOnReference_at_1Match newEmptyMatch() {
    return DominatedExplicitJudgementOnReference_at_1Match.newEmptyMatch();
  }
  
  @Override
  public DominatedExplicitJudgementOnReference_at_1Match newMatch(final Object... parameters) {
    return DominatedExplicitJudgementOnReference_at_1Match.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (org.eclipse.emf.ecore.EObject) parameters[2], (org.eclipse.emf.ecore.EReference) parameters[3], (org.mondo.collaboration.policy.rules.OperationType) parameters[4], (org.mondo.collaboration.policy.rules.AccessibilityLevel) parameters[5]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnReference_at_1QuerySpecification (visibility: PUBLIC, simpleName: DominatedExplicitJudgementOnReference_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnReference_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnReference_at_1QuerySpecification (visibility: PUBLIC, simpleName: DominatedExplicitJudgementOnReference_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnReference_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static DominatedExplicitJudgementOnReference_at_1QuerySpecification INSTANCE = new DominatedExplicitJudgementOnReference_at_1QuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static DominatedExplicitJudgementOnReference_at_1QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.security.increment.policy.dominatedExplicitJudgementOnReference_at_1";
    }
