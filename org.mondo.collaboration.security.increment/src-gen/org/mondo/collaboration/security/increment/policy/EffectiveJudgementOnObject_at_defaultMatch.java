...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnObject_at_default pattern,
 * to be used in conjunction with {@link EffectiveJudgementOnObject_at_defaultMatcher}.
 * 
...
public abstract class EffectiveJudgementOnObject_at_defaultMatch extends BasePatternMatch {
  ...
  private EffectiveJudgementOnObject_at_defaultMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return EffectiveJudgementOnObject_at_defaultMatch.parameterNames;
  }
  ...
  @Override
  public EffectiveJudgementOnObject_at_defaultMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof EffectiveJudgementOnObject_at_defaultMatch)) {
        EffectiveJudgementOnObject_at_defaultMatch other = (EffectiveJudgementOnObject_at_defaultMatch) obj;
  ...
  @Override
  public EffectiveJudgementOnObject_at_defaultQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EffectiveJudgementOnObject_at_defaultMatch newEmptyMatch() {
   ...
   * 
   */
  public static EffectiveJudgementOnObject_at_defaultMatch newMutableMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static EffectiveJudgementOnObject_at_defaultMatch newMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pObject, pOperation, pAccess);
  }
  
  private static final class Mutable extends EffectiveJudgementOnObject_at_defaultMatch {
  ...
  private static final class Immutable extends EffectiveJudgementOnObject_at_defaultMatch {
