...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.strongConsequenceOnAttribute_at_1 pattern,
 * to be used in conjunction with {@link StrongConsequenceOnAttribute_at_1Matcher}.
 * 
...
public abstract class StrongConsequenceOnAttribute_at_1Match extends BasePatternMatch {
  ...
  private StrongConsequenceOnAttribute_at_1Match(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return StrongConsequenceOnAttribute_at_1Match.parameterNames;
  }
  ...
  @Override
  public StrongConsequenceOnAttribute_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof StrongConsequenceOnAttribute_at_1Match)) {
        StrongConsequenceOnAttribute_at_1Match other = (StrongConsequenceOnAttribute_at_1Match) obj;
  ...
  @Override
  public StrongConsequenceOnAttribute_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static StrongConsequenceOnAttribute_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static StrongConsequenceOnAttribute_at_1Match newMutableMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static StrongConsequenceOnAttribute_at_1Match newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
  
  private static final class Mutable extends StrongConsequenceOnAttribute_at_1Match {
  ...
  private static final class Immutable extends StrongConsequenceOnAttribute_at_1Match {
