...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnObject_at_default pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class EffectiveJudgementOnObject_at_defaultProcessor implements IMatchProcessor<EffectiveJudgementOnObject_at_defaultMatch> {
  /**
  ...
  @Override
  public void process(final EffectiveJudgementOnObject_at_defaultMatch match) {
