...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.idAttribute pattern,
 * to be used in conjunction with {@link IdAttributeMatcher}.
 * 
...
public abstract class IdAttributeMatch extends BasePatternMatch {
  ...
  private IdAttributeMatch(final EObject pSource, final Object pValue, final EAttribute pAttribute) {
  ...
  public List<String> parameterNames() {
    return IdAttributeMatch.parameterNames;
  }
  ...
  @Override
  public IdAttributeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof IdAttributeMatch)) {
        IdAttributeMatch other = (IdAttributeMatch) obj;
  ...
  @Override
  public IdAttributeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static IdAttributeMatch newEmptyMatch() {
   ...
   * 
   */
  public static IdAttributeMatch newMutableMatch(final EObject pSource, final Object pValue, final EAttribute pAttribute) {
   ...
   * 
   */
  public static IdAttributeMatch newMatch(final EObject pSource, final Object pValue, final EAttribute pAttribute) {
    return new Immutable(pSource, pValue, pAttribute);
  }
  
  private static final class Mutable extends IdAttributeMatch {
  ...
  private static final class Immutable extends IdAttributeMatch {
