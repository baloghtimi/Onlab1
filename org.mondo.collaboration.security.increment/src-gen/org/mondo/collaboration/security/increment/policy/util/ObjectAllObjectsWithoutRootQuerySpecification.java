...
/**
 * A pattern-specific query specification that can instantiate ObjectAllObjectsWithoutRootMatcher in a type-safe way.
 * 
 * @see ObjectAllObjectsWithoutRootMatcher
 * @see ObjectAllObjectsWithoutRootMatch
 * 
 */
@SuppressWarnings("all")
public final class ObjectAllObjectsWithoutRootQuerySpecification extends BaseGeneratedEMFQuerySpecification<ObjectAllObjectsWithoutRootMatcher> {
  private ObjectAllObjectsWithoutRootQuerySpecification() {
   ...
   * 
   */
  public static ObjectAllObjectsWithoutRootQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected ObjectAllObjectsWithoutRootMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return ObjectAllObjectsWithoutRootMatcher.on(engine);
  }
  
  @Override
  public ObjectAllObjectsWithoutRootMatcher instantiate() throws ViatraQueryException {
    return ObjectAllObjectsWithoutRootMatcher.create();
  }
  
  @Override
  public ObjectAllObjectsWithoutRootMatch newEmptyMatch() {
    return ObjectAllObjectsWithoutRootMatch.newEmptyMatch();
  }
  
  @Override
  public ObjectAllObjectsWithoutRootMatch newMatch(final Object... parameters) {
    return ObjectAllObjectsWithoutRootMatch.newMatch((org.eclipse.emf.ecore.EObject) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.ObjectAllObjectsWithoutRootQuerySpecification (visibility: PUBLIC, simpleName: ObjectAllObjectsWithoutRootQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.ObjectAllObjectsWithoutRootQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.ObjectAllObjectsWithoutRootQuerySpecification (visibility: PUBLIC, simpleName: ObjectAllObjectsWithoutRootQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.ObjectAllObjectsWithoutRootQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static ObjectAllObjectsWithoutRootQuerySpecification INSTANCE = new ObjectAllObjectsWithoutRootQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ObjectAllObjectsWithoutRootQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.security.increment.policy.objectAllObjectsWithoutRoot";
    }
