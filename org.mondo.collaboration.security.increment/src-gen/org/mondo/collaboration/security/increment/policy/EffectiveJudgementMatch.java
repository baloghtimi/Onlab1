...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.effectiveJudgement pattern,
 * to be used in conjunction with {@link EffectiveJudgementMatcher}.
 * 
...
public abstract class EffectiveJudgementMatch extends BasePatternMatch {
  ...
  private EffectiveJudgementMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
    this.fUser = pUser;
    this.fAsset = pAsset;
  ...
  public List<String> parameterNames() {
    return EffectiveJudgementMatch.parameterNames;
  }
  ...
  @Override
  public EffectiveJudgementMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof EffectiveJudgementMatch)) {
        EffectiveJudgementMatch other = (EffectiveJudgementMatch) obj;
  ...
  @Override
  public EffectiveJudgementQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EffectiveJudgementMatch newEmptyMatch() {
   ...
   * 
   */
  public static EffectiveJudgementMatch newMutableMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public static EffectiveJudgementMatch newMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
    return new Immutable(pUser, pAsset, pOperation, pAccess);
  }
  
  private static final class Mutable extends EffectiveJudgementMatch {
  ...
  private static final class Immutable extends EffectiveJudgementMatch {
