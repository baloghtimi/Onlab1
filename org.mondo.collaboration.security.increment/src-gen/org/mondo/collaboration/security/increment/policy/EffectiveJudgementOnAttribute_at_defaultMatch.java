...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnAttribute_at_default pattern,
 * to be used in conjunction with {@link EffectiveJudgementOnAttribute_at_defaultMatcher}.
 * 
 ...
 * 
 * @see EffectiveJudgementOnAttribute_at_defaultMatcher
 *  @see EffectiveJudgementOnAttribute_at_defaultProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class EffectiveJudgementOnAttribute_at_defaultMatch extends BasePatternMatch {
  ...
  private EffectiveJudgementOnAttribute_at_defaultMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public String patternName() {
    return "org.mondo.collaboration.security.increment.policy.effectiveJudgementOnAttribute_at_default";
  }
  
  @Override
  public List<String> parameterNames() {
    return EffectiveJudgementOnAttribute_at_defaultMatch.parameterNames;
  }
  ...
  @Override
  public EffectiveJudgementOnAttribute_at_defaultMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof EffectiveJudgementOnAttribute_at_defaultMatch)) {
        EffectiveJudgementOnAttribute_at_defaultMatch other = (EffectiveJudgementOnAttribute_at_defaultMatch) obj;
  ...
  @Override
  public EffectiveJudgementOnAttribute_at_defaultQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EffectiveJudgementOnAttribute_at_defaultMatch newEmptyMatch() {
   ...
   * 
   */
  public static EffectiveJudgementOnAttribute_at_defaultMatch newMutableMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static EffectiveJudgementOnAttribute_at_defaultMatch newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
  
  private static final class Mutable extends EffectiveJudgementOnAttribute_at_defaultMatch {
    Mutable(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
  ...
  private static final class Immutable extends EffectiveJudgementOnAttribute_at_defaultMatch {
    Immutable(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
      super(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
    }
