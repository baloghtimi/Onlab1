...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.domination_of_0 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class Domination_of_0Processor implements IMatchProcessor<Domination_of_0Match> {
  /**
  ...
  @Override
  public void process(final Domination_of_0Match match) {
