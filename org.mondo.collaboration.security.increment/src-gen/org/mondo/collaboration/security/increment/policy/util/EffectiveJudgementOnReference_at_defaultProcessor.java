...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnReference_at_default pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class EffectiveJudgementOnReference_at_defaultProcessor implements IMatchProcessor<EffectiveJudgementOnReference_at_defaultMatch> {
  /**
  ...
  @Override
  public void process(final EffectiveJudgementOnReference_at_defaultMatch match) {
