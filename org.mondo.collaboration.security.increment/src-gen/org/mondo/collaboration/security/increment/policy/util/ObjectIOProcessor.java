...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.objectIO pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class ObjectIOProcessor implements IMatchProcessor<ObjectIOMatch> {
  /**
  ...
  @Override
  public void process(final ObjectIOMatch match) {
