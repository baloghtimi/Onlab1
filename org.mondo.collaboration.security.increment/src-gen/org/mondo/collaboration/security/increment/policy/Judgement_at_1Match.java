...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.judgement_at_1 pattern,
 * to be used in conjunction with {@link Judgement_at_1Matcher}.
 * 
...
public abstract class Judgement_at_1Match extends BasePatternMatch {
  ...
  private Judgement_at_1Match(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
    this.fAsset = pAsset;
  ...
  public List<String> parameterNames() {
    return Judgement_at_1Match.parameterNames;
  }
  ...
  @Override
  public Judgement_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof Judgement_at_1Match)) {
        Judgement_at_1Match other = (Judgement_at_1Match) obj;
  ...
  @Override
  public Judgement_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static Judgement_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static Judgement_at_1Match newMutableMatch(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static Judgement_at_1Match newMatch(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pAsset, pOperation, pAccess);
  }
  
  private static final class Mutable extends Judgement_at_1Match {
  ...
  private static final class Immutable extends Judgement_at_1Match {
