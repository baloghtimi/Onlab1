...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnObject_at_1 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link EffectiveJudgementOnObject_at_1Match}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 *  @see EffectiveJudgementOnObject_at_1Processor
 * @see EffectiveJudgementOnObject_at_1QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class EffectiveJudgementOnObject_at_1Matcher extends BaseMatcher<EffectiveJudgementOnObject_at_1Match> {
  /**
   ...
   * 
   */
  public static EffectiveJudgementOnObject_at_1Matcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    EffectiveJudgementOnObject_at_1Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (EffectiveJudgementOnObject_at_1Matcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static EffectiveJudgementOnObject_at_1Matcher create() throws ViatraQueryException {
    return new EffectiveJudgementOnObject_at_1Matcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EffectiveJudgementOnObject_at_1Matcher.class);
   ...
   * 
   */
  private EffectiveJudgementOnObject_at_1Matcher() throws ViatraQueryException {
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final EffectiveJudgementOnObject_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfobject(final EffectiveJudgementOnObject_at_1Match partialMatch) {
  ...
  @Override
  protected EffectiveJudgementOnObject_at_1Match tupleToMatch(final Tuple t) {
    try {
        return EffectiveJudgementOnObject_at_1Match.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_OBJECT), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_ACCESS));
  ...
  @Override
  protected EffectiveJudgementOnObject_at_1Match arrayToMatch(final Object[] match) {
    try {
        return EffectiveJudgementOnObject_at_1Match.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_OBJECT], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected EffectiveJudgementOnObject_at_1Match arrayToMatchMutable(final Object[] match) {
    try {
        return EffectiveJudgementOnObject_at_1Match.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_OBJECT], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<EffectiveJudgementOnObject_at_1Matcher> querySpecification() throws ViatraQueryException {
