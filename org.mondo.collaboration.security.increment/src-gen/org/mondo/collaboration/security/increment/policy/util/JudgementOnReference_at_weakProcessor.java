...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.judgementOnReference_at_weak pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class JudgementOnReference_at_weakProcessor implements IMatchProcessor<JudgementOnReference_at_weakMatch> {
  /**
  ...
  @Override
  public void process(final JudgementOnReference_at_weakMatch match) {
