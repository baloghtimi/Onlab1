...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.judgement_at_0 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class Judgement_at_0Processor implements IMatchProcessor<Judgement_at_0Match> {
  /**
  ...
  @Override
  public void process(final Judgement_at_0Match match) {
