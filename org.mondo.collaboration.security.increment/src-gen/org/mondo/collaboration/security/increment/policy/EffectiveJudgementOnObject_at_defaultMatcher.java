...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnObject_at_default pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link EffectiveJudgementOnObject_at_defaultMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 *  @see EffectiveJudgementOnObject_at_defaultProcessor
 * @see EffectiveJudgementOnObject_at_defaultQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class EffectiveJudgementOnObject_at_defaultMatcher extends BaseMatcher<EffectiveJudgementOnObject_at_defaultMatch> {
  /**
   ...
   * 
   */
  public static EffectiveJudgementOnObject_at_defaultMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    EffectiveJudgementOnObject_at_defaultMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (EffectiveJudgementOnObject_at_defaultMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static EffectiveJudgementOnObject_at_defaultMatcher create() throws ViatraQueryException {
    return new EffectiveJudgementOnObject_at_defaultMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EffectiveJudgementOnObject_at_defaultMatcher.class);
   ...
   * 
   */
  private EffectiveJudgementOnObject_at_defaultMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a EffectiveJudgementOnObject_at_defaultMatch object.
   * 
   */
  public Collection<EffectiveJudgementOnObject_at_defaultMatch> getAllMatches(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a EffectiveJudgementOnObject_at_defaultMatch object, or null if no match is found.
   * 
   */
  public EffectiveJudgementOnObject_at_defaultMatch getOneArbitraryMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super EffectiveJudgementOnObject_at_defaultMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super EffectiveJudgementOnObject_at_defaultMatch> processor) {
   ...
   * 
   */
  public EffectiveJudgementOnObject_at_defaultMatch newMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return EffectiveJudgementOnObject_at_defaultMatch.newMatch(pUser, pObject, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final EffectiveJudgementOnObject_at_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfobject(final EffectiveJudgementOnObject_at_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfoperation(final EffectiveJudgementOnObject_at_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfaccess(final EffectiveJudgementOnObject_at_defaultMatch partialMatch) {
  ...
  @Override
  protected EffectiveJudgementOnObject_at_defaultMatch tupleToMatch(final Tuple t) {
    try {
        return EffectiveJudgementOnObject_at_defaultMatch.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_OBJECT), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_ACCESS));
  ...
  @Override
  protected EffectiveJudgementOnObject_at_defaultMatch arrayToMatch(final Object[] match) {
    try {
        return EffectiveJudgementOnObject_at_defaultMatch.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_OBJECT], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected EffectiveJudgementOnObject_at_defaultMatch arrayToMatchMutable(final Object[] match) {
    try {
        return EffectiveJudgementOnObject_at_defaultMatch.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_OBJECT], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<EffectiveJudgementOnObject_at_defaultMatcher> querySpecification() throws ViatraQueryException {
