...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.dominatedExplicitJudgementOnReference_at_1 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link DominatedExplicitJudgementOnReference_at_1Match}.
 * 
 * <p>Original source:
 * <code><pre>
 * pattern dominatedExplicitJudgementOnReference_at_1(user: java String, source: EObject, target: EObject, reference: EReference, operation, prevailingAccess) 
 * {
 ...
 * </pre></code>
 * 
 * @see DominatedExplicitJudgementOnReference_at_1Match
 *  @see DominatedExplicitJudgementOnReference_at_1Processor
 * @see DominatedExplicitJudgementOnReference_at_1QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class DominatedExplicitJudgementOnReference_at_1Matcher extends BaseMatcher<DominatedExplicitJudgementOnReference_at_1Match> {
  /**
   ...
   * 
   */
  public static DominatedExplicitJudgementOnReference_at_1Matcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    DominatedExplicitJudgementOnReference_at_1Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (DominatedExplicitJudgementOnReference_at_1Matcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static DominatedExplicitJudgementOnReference_at_1Matcher create() throws ViatraQueryException {
    return new DominatedExplicitJudgementOnReference_at_1Matcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DominatedExplicitJudgementOnReference_at_1Matcher.class);
   ...
   * 
   */
  private DominatedExplicitJudgementOnReference_at_1Matcher() throws ViatraQueryException {
   ...
   * @return matches represented as a DominatedExplicitJudgementOnReference_at_1Match object.
   * 
   */
  public Collection<DominatedExplicitJudgementOnReference_at_1Match> getAllMatches(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pPrevailingAccess the fixed value of pattern parameter prevailingAccess, or null if not bound.
   * @return a match represented as a DominatedExplicitJudgementOnReference_at_1Match object, or null if no match is found.
   * 
   */
  public DominatedExplicitJudgementOnReference_at_1Match getOneArbitraryMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess, final IMatchProcessor<? super DominatedExplicitJudgementOnReference_at_1Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess, final IMatchProcessor<? super DominatedExplicitJudgementOnReference_at_1Match> processor) {
   ...
   * 
   */
  public DominatedExplicitJudgementOnReference_at_1Match newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
    return DominatedExplicitJudgementOnReference_at_1Match.newMatch(pUser, pSource, pTarget, pReference, pOperation, pPrevailingAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final DominatedExplicitJudgementOnReference_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfsource(final DominatedExplicitJudgementOnReference_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOftarget(final DominatedExplicitJudgementOnReference_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EReference> getAllValuesOfreference(final DominatedExplicitJudgementOnReference_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfoperation(final DominatedExplicitJudgementOnReference_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfprevailingAccess(final DominatedExplicitJudgementOnReference_at_1Match partialMatch) {
  ...
  @Override
  protected DominatedExplicitJudgementOnReference_at_1Match tupleToMatch(final Tuple t) {
    try {
        return DominatedExplicitJudgementOnReference_at_1Match.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_SOURCE), (EObject) t.get(POSITION_TARGET), (EReference) t.get(POSITION_REFERENCE), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_PREVAILINGACCESS));
  ...
  @Override
  protected DominatedExplicitJudgementOnReference_at_1Match arrayToMatch(final Object[] match) {
    try {
        return DominatedExplicitJudgementOnReference_at_1Match.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (EObject) match[POSITION_TARGET], (EReference) match[POSITION_REFERENCE], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_PREVAILINGACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected DominatedExplicitJudgementOnReference_at_1Match arrayToMatchMutable(final Object[] match) {
    try {
        return DominatedExplicitJudgementOnReference_at_1Match.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (EObject) match[POSITION_TARGET], (EReference) match[POSITION_REFERENCE], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_PREVAILINGACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<DominatedExplicitJudgementOnReference_at_1Matcher> querySpecification() throws ViatraQueryException {
