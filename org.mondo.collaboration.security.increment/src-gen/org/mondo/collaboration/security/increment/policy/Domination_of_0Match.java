...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.domination_of_0 pattern,
 * to be used in conjunction with {@link Domination_of_0Matcher}.
 * 
...
public abstract class Domination_of_0Match extends BasePatternMatch {
  ...
  private Domination_of_0Match(final String pUser, final EObject pAsset, final Object pOperation, final AccessibilityLevel pDominatedAccess, final AccessibilityLevel pPrevailingAccess) {
    this.fUser = pUser;
    this.fAsset = pAsset;
  ...
  public List<String> parameterNames() {
    return Domination_of_0Match.parameterNames;
  }
  ...
  @Override
  public Domination_of_0Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof Domination_of_0Match)) {
        Domination_of_0Match other = (Domination_of_0Match) obj;
  ...
  @Override
  public Domination_of_0QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static Domination_of_0Match newEmptyMatch() {
   ...
   * 
   */
  public static Domination_of_0Match newMutableMatch(final String pUser, final EObject pAsset, final Object pOperation, final AccessibilityLevel pDominatedAccess, final AccessibilityLevel pPrevailingAccess) {
   ...
   * 
   */
  public static Domination_of_0Match newMatch(final String pUser, final EObject pAsset, final Object pOperation, final AccessibilityLevel pDominatedAccess, final AccessibilityLevel pPrevailingAccess) {
    return new Immutable(pUser, pAsset, pOperation, pDominatedAccess, pPrevailingAccess);
  }
  
  private static final class Mutable extends Domination_of_0Match {
  ...
  private static final class Immutable extends Domination_of_0Match {
