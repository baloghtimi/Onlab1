...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.dominatedExplicitJudgementOnAttribute_at_1 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class DominatedExplicitJudgementOnAttribute_at_1Processor implements IMatchProcessor<DominatedExplicitJudgementOnAttribute_at_1Match> {
  /**
  ...
  @Override
  public void process(final DominatedExplicitJudgementOnAttribute_at_1Match match) {
