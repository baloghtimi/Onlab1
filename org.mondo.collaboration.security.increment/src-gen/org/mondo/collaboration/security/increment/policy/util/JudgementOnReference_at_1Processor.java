...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.judgementOnReference_at_1 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class JudgementOnReference_at_1Processor implements IMatchProcessor<JudgementOnReference_at_1Match> {
  /**
  ...
  @Override
  public void process(final JudgementOnReference_at_1Match match) {
