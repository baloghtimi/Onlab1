...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnAttribute pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link EffectiveJudgementOnAttributeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 *  @see EffectiveJudgementOnAttributeProcessor
 * @see EffectiveJudgementOnAttributeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class EffectiveJudgementOnAttributeMatcher extends BaseMatcher<EffectiveJudgementOnAttributeMatch> {
  /**
   ...
   * 
   */
  public static EffectiveJudgementOnAttributeMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    EffectiveJudgementOnAttributeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (EffectiveJudgementOnAttributeMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static EffectiveJudgementOnAttributeMatcher create() throws ViatraQueryException {
    return new EffectiveJudgementOnAttributeMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EffectiveJudgementOnAttributeMatcher.class);
   ...
   * 
   */
  private EffectiveJudgementOnAttributeMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a EffectiveJudgementOnAttributeMatch object.
   * 
   */
  public Collection<EffectiveJudgementOnAttributeMatch> getAllMatches(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a EffectiveJudgementOnAttributeMatch object, or null if no match is found.
   * 
   */
  public EffectiveJudgementOnAttributeMatch getOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super EffectiveJudgementOnAttributeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super EffectiveJudgementOnAttributeMatch> processor) {
   ...
   * 
   */
  public EffectiveJudgementOnAttributeMatch newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return EffectiveJudgementOnAttributeMatch.newMatch(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final EffectiveJudgementOnAttributeMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfsource(final EffectiveJudgementOnAttributeMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfvalue(final EffectiveJudgementOnAttributeMatch partialMatch) {
   ...
   * 
   */
  public Set<EAttribute> getAllValuesOfattribute(final EffectiveJudgementOnAttributeMatch partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfoperation(final EffectiveJudgementOnAttributeMatch partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfaccess(final EffectiveJudgementOnAttributeMatch partialMatch) {
  ...
  @Override
  protected EffectiveJudgementOnAttributeMatch tupleToMatch(final Tuple t) {
    try {
        return EffectiveJudgementOnAttributeMatch.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_SOURCE), (Object) t.get(POSITION_VALUE), (EAttribute) t.get(POSITION_ATTRIBUTE), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_ACCESS));
  ...
  @Override
  protected EffectiveJudgementOnAttributeMatch arrayToMatch(final Object[] match) {
    try {
        return EffectiveJudgementOnAttributeMatch.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected EffectiveJudgementOnAttributeMatch arrayToMatchMutable(final Object[] match) {
    try {
        return EffectiveJudgementOnAttributeMatch.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<EffectiveJudgementOnAttributeMatcher> querySpecification() throws ViatraQueryException {
