...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnAttribute_at_1 pattern,
 * to be used in conjunction with {@link EffectiveJudgementOnAttribute_at_1Matcher}.
 * 
...
public abstract class EffectiveJudgementOnAttribute_at_1Match extends BasePatternMatch {
  ...
  private EffectiveJudgementOnAttribute_at_1Match(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return EffectiveJudgementOnAttribute_at_1Match.parameterNames;
  }
  ...
  @Override
  public EffectiveJudgementOnAttribute_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof EffectiveJudgementOnAttribute_at_1Match)) {
        EffectiveJudgementOnAttribute_at_1Match other = (EffectiveJudgementOnAttribute_at_1Match) obj;
  ...
  @Override
  public EffectiveJudgementOnAttribute_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EffectiveJudgementOnAttribute_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static EffectiveJudgementOnAttribute_at_1Match newMutableMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static EffectiveJudgementOnAttribute_at_1Match newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
  
  private static final class Mutable extends EffectiveJudgementOnAttribute_at_1Match {
  ...
  private static final class Immutable extends EffectiveJudgementOnAttribute_at_1Match {
