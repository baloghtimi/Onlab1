...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.dominationOnAttribute_of_weak pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class DominationOnAttribute_of_weakProcessor implements IMatchProcessor<DominationOnAttribute_of_weakMatch> {
  /**
  ...
  @Override
  public void process(final DominationOnAttribute_of_weakMatch match) {
