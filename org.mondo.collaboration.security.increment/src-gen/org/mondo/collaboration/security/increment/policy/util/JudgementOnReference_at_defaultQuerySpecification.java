...
/**
 * A pattern-specific query specification that can instantiate JudgementOnReference_at_defaultMatcher in a type-safe way.
 * 
 * @see JudgementOnReference_at_defaultMatcher
 * @see JudgementOnReference_at_defaultMatch
 * 
 */
@SuppressWarnings("all")
public final class JudgementOnReference_at_defaultQuerySpecification extends BaseGeneratedEMFQuerySpecification<JudgementOnReference_at_defaultMatcher> {
  private JudgementOnReference_at_defaultQuerySpecification() {
   ...
   * 
   */
  public static JudgementOnReference_at_defaultQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected JudgementOnReference_at_defaultMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return JudgementOnReference_at_defaultMatcher.on(engine);
  }
  
  @Override
  public JudgementOnReference_at_defaultMatcher instantiate() throws ViatraQueryException {
    return JudgementOnReference_at_defaultMatcher.create();
  }
  
  @Override
  public JudgementOnReference_at_defaultMatch newEmptyMatch() {
    return JudgementOnReference_at_defaultMatch.newEmptyMatch();
  }
  
  @Override
  public JudgementOnReference_at_defaultMatch newMatch(final Object... parameters) {
    return JudgementOnReference_at_defaultMatch.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (org.eclipse.emf.ecore.EObject) parameters[2], (org.eclipse.emf.ecore.EReference) parameters[3], (org.mondo.collaboration.policy.rules.OperationType) parameters[4], (org.mondo.collaboration.policy.rules.AccessibilityLevel) parameters[5]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.JudgementOnReference_at_defaultQuerySpecification (visibility: PUBLIC, simpleName: JudgementOnReference_at_defaultQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.JudgementOnReference_at_defaultQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.JudgementOnReference_at_defaultQuerySpecification (visibility: PUBLIC, simpleName: JudgementOnReference_at_defaultQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.JudgementOnReference_at_defaultQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static JudgementOnReference_at_defaultQuerySpecification INSTANCE = new JudgementOnReference_at_defaultQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static JudgementOnReference_at_defaultQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.security.increment.policy.judgementOnReference_at_default";
    }
      ...
      try {
          {
              ...
              new ExpressionEvaluation(body, new IExpressionEvaluator() {
                  ...
                  public String getShortDescription() {
                      return "Expression evaluation from pattern judgementOnReference_at_default";
                  }
