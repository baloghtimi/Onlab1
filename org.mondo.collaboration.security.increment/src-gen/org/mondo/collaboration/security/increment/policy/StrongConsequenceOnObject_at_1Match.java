...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.strongConsequenceOnObject_at_1 pattern,
 * to be used in conjunction with {@link StrongConsequenceOnObject_at_1Matcher}.
 * 
...
public abstract class StrongConsequenceOnObject_at_1Match extends BasePatternMatch {
  ...
  private StrongConsequenceOnObject_at_1Match(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return StrongConsequenceOnObject_at_1Match.parameterNames;
  }
  ...
  @Override
  public StrongConsequenceOnObject_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof StrongConsequenceOnObject_at_1Match)) {
        StrongConsequenceOnObject_at_1Match other = (StrongConsequenceOnObject_at_1Match) obj;
  ...
  @Override
  public StrongConsequenceOnObject_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static StrongConsequenceOnObject_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static StrongConsequenceOnObject_at_1Match newMutableMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static StrongConsequenceOnObject_at_1Match newMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pObject, pOperation, pAccess);
  }
  
  private static final class Mutable extends StrongConsequenceOnObject_at_1Match {
  ...
  private static final class Immutable extends StrongConsequenceOnObject_at_1Match {
