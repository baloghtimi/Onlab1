...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.dominationOnAttribute_of_default pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link DominationOnAttribute_of_defaultMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see DominationOnAttribute_of_defaultQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class DominationOnAttribute_of_defaultMatcher extends BaseMatcher<DominationOnAttribute_of_defaultMatch> {
  /**
   ...
   * 
   */
  public static DominationOnAttribute_of_defaultMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    DominationOnAttribute_of_defaultMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (DominationOnAttribute_of_defaultMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static DominationOnAttribute_of_defaultMatcher create() throws ViatraQueryException {
    return new DominationOnAttribute_of_defaultMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DominationOnAttribute_of_defaultMatcher.class);
   ...
   * 
   */
  private DominationOnAttribute_of_defaultMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a DominationOnAttribute_of_defaultMatch object.
   * 
   */
  public Collection<DominationOnAttribute_of_defaultMatch> getAllMatches(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation) {
   ...
   * @param pAttribute the fixed value of pattern parameter attribute, or null if not bound.
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @return a match represented as a DominationOnAttribute_of_defaultMatch object, or null if no match is found.
   * 
   */
  public DominationOnAttribute_of_defaultMatch getOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation, final IMatchProcessor<? super DominationOnAttribute_of_defaultMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation, final IMatchProcessor<? super DominationOnAttribute_of_defaultMatch> processor) {
   ...
   * 
   */
  public DominationOnAttribute_of_defaultMatch newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation) {
    return DominationOnAttribute_of_defaultMatch.newMatch(pUser, pSource, pValue, pAttribute, pOperation);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final DominationOnAttribute_of_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfsource(final DominationOnAttribute_of_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfvalue(final DominationOnAttribute_of_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<EAttribute> getAllValuesOfattribute(final DominationOnAttribute_of_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfoperation(final DominationOnAttribute_of_defaultMatch partialMatch) {
  ...
  @Override
  protected DominationOnAttribute_of_defaultMatch tupleToMatch(final Tuple t) {
    try {
        return DominationOnAttribute_of_defaultMatch.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_SOURCE), (Object) t.get(POSITION_VALUE), (EAttribute) t.get(POSITION_ATTRIBUTE), (Object) t.get(POSITION_OPERATION));
  ...
  @Override
  protected DominationOnAttribute_of_defaultMatch arrayToMatch(final Object[] match) {
    try {
        return DominationOnAttribute_of_defaultMatch.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (Object) match[POSITION_OPERATION]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected DominationOnAttribute_of_defaultMatch arrayToMatchMutable(final Object[] match) {
    try {
        return DominationOnAttribute_of_defaultMatch.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (Object) match[POSITION_OPERATION]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<DominationOnAttribute_of_defaultMatcher> querySpecification() throws ViatraQueryException {
