...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.strongConsequence_at_1 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link StrongConsequence_at_1Match}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see StrongConsequence_at_1Match
 *  @see StrongConsequence_at_1Processor
 * @see StrongConsequence_at_1QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class StrongConsequence_at_1Matcher extends BaseMatcher<StrongConsequence_at_1Match> {
  /**
   ...
   * 
   */
  public static StrongConsequence_at_1Matcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    StrongConsequence_at_1Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (StrongConsequence_at_1Matcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static StrongConsequence_at_1Matcher create() throws ViatraQueryException {
    return new StrongConsequence_at_1Matcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StrongConsequence_at_1Matcher.class);
   ...
   * 
   */
  private StrongConsequence_at_1Matcher() throws ViatraQueryException {
   ...
   * @return matches represented as a StrongConsequence_at_1Match object.
   * 
   */
  public Collection<StrongConsequence_at_1Match> getAllMatches(final String pUser, final EObject pDepAsset, final OperationType pDepOp, final AccessibilityLevel pDepAccess, final EObject pDomAsset, final OperationType pDomOp, final AccessibilityLevel pDomAccess) {
   ...
   * @param pDomOp the fixed value of pattern parameter domOp, or null if not bound.
   * @param pDomAccess the fixed value of pattern parameter domAccess, or null if not bound.
   * @return a match represented as a StrongConsequence_at_1Match object, or null if no match is found.
   * 
   */
  public StrongConsequence_at_1Match getOneArbitraryMatch(final String pUser, final EObject pDepAsset, final OperationType pDepOp, final AccessibilityLevel pDepAccess, final EObject pDomAsset, final OperationType pDomOp, final AccessibilityLevel pDomAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pDepAsset, final OperationType pDepOp, final AccessibilityLevel pDepAccess, final EObject pDomAsset, final OperationType pDomOp, final AccessibilityLevel pDomAccess, final IMatchProcessor<? super StrongConsequence_at_1Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pDepAsset, final OperationType pDepOp, final AccessibilityLevel pDepAccess, final EObject pDomAsset, final OperationType pDomOp, final AccessibilityLevel pDomAccess, final IMatchProcessor<? super StrongConsequence_at_1Match> processor) {
   ...
   * 
   */
  public StrongConsequence_at_1Match newMatch(final String pUser, final EObject pDepAsset, final OperationType pDepOp, final AccessibilityLevel pDepAccess, final EObject pDomAsset, final OperationType pDomOp, final AccessibilityLevel pDomAccess) {
    return StrongConsequence_at_1Match.newMatch(pUser, pDepAsset, pDepOp, pDepAccess, pDomAsset, pDomOp, pDomAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final StrongConsequence_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfdepAsset(final StrongConsequence_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfdepOp(final StrongConsequence_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfdepAccess(final StrongConsequence_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfdomAsset(final StrongConsequence_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfdomOp(final StrongConsequence_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfdomAccess(final StrongConsequence_at_1Match partialMatch) {
  ...
  @Override
  protected StrongConsequence_at_1Match tupleToMatch(final Tuple t) {
    try {
        return StrongConsequence_at_1Match.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_DEPASSET), (OperationType) t.get(POSITION_DEPOP), (AccessibilityLevel) t.get(POSITION_DEPACCESS), (EObject) t.get(POSITION_DOMASSET), (OperationType) t.get(POSITION_DOMOP), (AccessibilityLevel) t.get(POSITION_DOMACCESS));
  ...
  @Override
  protected StrongConsequence_at_1Match arrayToMatch(final Object[] match) {
    try {
        return StrongConsequence_at_1Match.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_DEPASSET], (OperationType) match[POSITION_DEPOP], (AccessibilityLevel) match[POSITION_DEPACCESS], (EObject) match[POSITION_DOMASSET], (OperationType) match[POSITION_DOMOP], (AccessibilityLevel) match[POSITION_DOMACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected StrongConsequence_at_1Match arrayToMatchMutable(final Object[] match) {
    try {
        return StrongConsequence_at_1Match.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_DEPASSET], (OperationType) match[POSITION_DEPOP], (AccessibilityLevel) match[POSITION_DEPACCESS], (EObject) match[POSITION_DOMASSET], (OperationType) match[POSITION_DOMOP], (AccessibilityLevel) match[POSITION_DOMACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<StrongConsequence_at_1Matcher> querySpecification() throws ViatraQueryException {
