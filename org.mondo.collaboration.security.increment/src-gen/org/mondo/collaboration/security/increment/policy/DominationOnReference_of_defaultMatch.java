...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.dominationOnReference_of_default pattern,
 * to be used in conjunction with {@link DominationOnReference_of_defaultMatcher}.
 * 
...
public abstract class DominationOnReference_of_defaultMatch extends BasePatternMatch {
  ...
  private DominationOnReference_of_defaultMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return DominationOnReference_of_defaultMatch.parameterNames;
  }
  ...
  @Override
  public DominationOnReference_of_defaultMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof DominationOnReference_of_defaultMatch)) {
        DominationOnReference_of_defaultMatch other = (DominationOnReference_of_defaultMatch) obj;
  ...
  @Override
  public DominationOnReference_of_defaultQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static DominationOnReference_of_defaultMatch newEmptyMatch() {
   ...
   * 
   */
  public static DominationOnReference_of_defaultMatch newMutableMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation) {
   ...
   * 
   */
  public static DominationOnReference_of_defaultMatch newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation) {
    return new Immutable(pUser, pSource, pTarget, pReference, pOperation);
  }
  
  private static final class Mutable extends DominationOnReference_of_defaultMatch {
  ...
  private static final class Immutable extends DominationOnReference_of_defaultMatch {
