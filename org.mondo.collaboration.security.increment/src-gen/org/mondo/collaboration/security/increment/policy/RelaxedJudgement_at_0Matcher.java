...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.relaxedJudgement_at_0 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link RelaxedJudgement_at_0Match}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see RelaxedJudgement_at_0Match
 *  @see RelaxedJudgement_at_0Processor
 * @see RelaxedJudgement_at_0QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class RelaxedJudgement_at_0Matcher extends BaseMatcher<RelaxedJudgement_at_0Match> {
  /**
   ...
   * 
   */
  public static RelaxedJudgement_at_0Matcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    RelaxedJudgement_at_0Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (RelaxedJudgement_at_0Matcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static RelaxedJudgement_at_0Matcher create() throws ViatraQueryException {
    return new RelaxedJudgement_at_0Matcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RelaxedJudgement_at_0Matcher.class);
   ...
   * 
   */
  private RelaxedJudgement_at_0Matcher() throws ViatraQueryException {
   ...
   * @return matches represented as a RelaxedJudgement_at_0Match object.
   * 
   */
  public Collection<RelaxedJudgement_at_0Match> getAllMatches(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a RelaxedJudgement_at_0Match object, or null if no match is found.
   * 
   */
  public RelaxedJudgement_at_0Match getOneArbitraryMatch(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super RelaxedJudgement_at_0Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super RelaxedJudgement_at_0Match> processor) {
   ...
   * 
   */
  public RelaxedJudgement_at_0Match newMatch(final String pUser, final EObject pAsset, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return RelaxedJudgement_at_0Match.newMatch(pUser, pAsset, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final RelaxedJudgement_at_0Match partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfasset(final RelaxedJudgement_at_0Match partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfoperation(final RelaxedJudgement_at_0Match partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfaccess(final RelaxedJudgement_at_0Match partialMatch) {
  ...
  @Override
  protected RelaxedJudgement_at_0Match tupleToMatch(final Tuple t) {
    try {
        return RelaxedJudgement_at_0Match.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_ASSET), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_ACCESS));
  ...
  @Override
  protected RelaxedJudgement_at_0Match arrayToMatch(final Object[] match) {
    try {
        return RelaxedJudgement_at_0Match.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_ASSET], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected RelaxedJudgement_at_0Match arrayToMatchMutable(final Object[] match) {
    try {
        return RelaxedJudgement_at_0Match.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_ASSET], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<RelaxedJudgement_at_0Matcher> querySpecification() throws ViatraQueryException {
