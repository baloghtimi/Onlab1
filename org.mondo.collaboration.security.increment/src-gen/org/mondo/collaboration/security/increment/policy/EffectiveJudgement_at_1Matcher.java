...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.effectiveJudgement_at_1 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link EffectiveJudgement_at_1Match}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see EffectiveJudgement_at_1QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class EffectiveJudgement_at_1Matcher extends BaseMatcher<EffectiveJudgement_at_1Match> {
  /**
   ...
   * 
   */
  public static EffectiveJudgement_at_1Matcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    EffectiveJudgement_at_1Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (EffectiveJudgement_at_1Matcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static EffectiveJudgement_at_1Matcher create() throws ViatraQueryException {
    return new EffectiveJudgement_at_1Matcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EffectiveJudgement_at_1Matcher.class);
   ...
   * 
   */
  private EffectiveJudgement_at_1Matcher() throws ViatraQueryException {
   ...
   * @return matches represented as a EffectiveJudgement_at_1Match object.
   * 
   */
  public Collection<EffectiveJudgement_at_1Match> getAllMatches(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a EffectiveJudgement_at_1Match object, or null if no match is found.
   * 
   */
  public EffectiveJudgement_at_1Match getOneArbitraryMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess, final IMatchProcessor<? super EffectiveJudgement_at_1Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess, final IMatchProcessor<? super EffectiveJudgement_at_1Match> processor) {
   ...
   * 
   */
  public EffectiveJudgement_at_1Match newMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
    return EffectiveJudgement_at_1Match.newMatch(pUser, pAsset, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final EffectiveJudgement_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfasset(final EffectiveJudgement_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfoperation(final EffectiveJudgement_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfaccess(final EffectiveJudgement_at_1Match partialMatch) {
  ...
  @Override
  protected EffectiveJudgement_at_1Match tupleToMatch(final Tuple t) {
    try {
        return EffectiveJudgement_at_1Match.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_ASSET), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_ACCESS));
  ...
  @Override
  protected EffectiveJudgement_at_1Match arrayToMatch(final Object[] match) {
    try {
        return EffectiveJudgement_at_1Match.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_ASSET], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected EffectiveJudgement_at_1Match arrayToMatchMutable(final Object[] match) {
    try {
        return EffectiveJudgement_at_1Match.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_ASSET], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<EffectiveJudgement_at_1Matcher> querySpecification() throws ViatraQueryException {
