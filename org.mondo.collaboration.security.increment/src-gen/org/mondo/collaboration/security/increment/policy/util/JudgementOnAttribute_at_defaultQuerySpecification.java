...
/**
 * A pattern-specific query specification that can instantiate JudgementOnAttribute_at_defaultMatcher in a type-safe way.
 * 
 * @see JudgementOnAttribute_at_defaultMatcher
 * @see JudgementOnAttribute_at_defaultMatch
 * 
 */
@SuppressWarnings("all")
public final class JudgementOnAttribute_at_defaultQuerySpecification extends BaseGeneratedEMFQuerySpecification<JudgementOnAttribute_at_defaultMatcher> {
  private JudgementOnAttribute_at_defaultQuerySpecification() {
   ...
   * 
   */
  public static JudgementOnAttribute_at_defaultQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected JudgementOnAttribute_at_defaultMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return JudgementOnAttribute_at_defaultMatcher.on(engine);
  }
  
  @Override
  public JudgementOnAttribute_at_defaultMatcher instantiate() throws ViatraQueryException {
    return JudgementOnAttribute_at_defaultMatcher.create();
  }
  
  @Override
  public JudgementOnAttribute_at_defaultMatch newEmptyMatch() {
    return JudgementOnAttribute_at_defaultMatch.newEmptyMatch();
  }
  
  @Override
  public JudgementOnAttribute_at_defaultMatch newMatch(final Object... parameters) {
    return JudgementOnAttribute_at_defaultMatch.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (java.lang.Object) parameters[2], (org.eclipse.emf.ecore.EAttribute) parameters[3], (org.mondo.collaboration.policy.rules.OperationType) parameters[4], (org.mondo.collaboration.policy.rules.AccessibilityLevel) parameters[5]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.JudgementOnAttribute_at_defaultQuerySpecification (visibility: PUBLIC, simpleName: JudgementOnAttribute_at_defaultQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.JudgementOnAttribute_at_defaultQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.JudgementOnAttribute_at_defaultQuerySpecification (visibility: PUBLIC, simpleName: JudgementOnAttribute_at_defaultQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.JudgementOnAttribute_at_defaultQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static JudgementOnAttribute_at_defaultQuerySpecification INSTANCE = new JudgementOnAttribute_at_defaultQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static JudgementOnAttribute_at_defaultQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.security.increment.policy.judgementOnAttribute_at_default";
    }
      ...
      try {
          {
              ...
              new ExpressionEvaluation(body, new IExpressionEvaluator() {
                  ...
                  public String getShortDescription() {
                      return "Expression evaluation from pattern judgementOnAttribute_at_default";
                  }
