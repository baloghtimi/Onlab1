...
/**
 * A pattern-specific query specification that can instantiate RelaxedJudgement_at_0Matcher in a type-safe way.
 * 
 * @see RelaxedJudgement_at_0Matcher
 * @see RelaxedJudgement_at_0Match
 * 
 */
@SuppressWarnings("all")
public final class RelaxedJudgement_at_0QuerySpecification extends BaseGeneratedEMFQuerySpecification<RelaxedJudgement_at_0Matcher> {
  private RelaxedJudgement_at_0QuerySpecification() {
   ...
   * 
   */
  public static RelaxedJudgement_at_0QuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected RelaxedJudgement_at_0Matcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return RelaxedJudgement_at_0Matcher.on(engine);
  }
  
  @Override
  public RelaxedJudgement_at_0Matcher instantiate() throws ViatraQueryException {
    return RelaxedJudgement_at_0Matcher.create();
  }
  
  @Override
  public RelaxedJudgement_at_0Match newEmptyMatch() {
    return RelaxedJudgement_at_0Match.newEmptyMatch();
  }
  
  @Override
  public RelaxedJudgement_at_0Match newMatch(final Object... parameters) {
    return RelaxedJudgement_at_0Match.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (org.mondo.collaboration.security.increment.vocabulary.OperationType) parameters[2], (org.mondo.collaboration.security.increment.vocabulary.AccessibilityLevel) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.RelaxedJudgement_at_0QuerySpecification (visibility: PUBLIC, simpleName: RelaxedJudgement_at_0QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.RelaxedJudgement_at_0QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.RelaxedJudgement_at_0QuerySpecification (visibility: PUBLIC, simpleName: RelaxedJudgement_at_0QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.RelaxedJudgement_at_0QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static RelaxedJudgement_at_0QuerySpecification INSTANCE = new RelaxedJudgement_at_0QuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static RelaxedJudgement_at_0QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.security.increment.policy.relaxedJudgement_at_0";
    }
      ...
      try {
          {
              ...
              PVariable var__dominatedAccess = body.getOrCreateVariableByName("_dominatedAccess");
              ...
              new PositivePatternCall(body, new FlatTuple(var_user, var_asset, var_operation, var_dominatedAccess), Judgement_at_0QuerySpecification.instance().getInternalQueryRepresentation());
              // 	find domination_of_0(user, asset, operation, _dominatedAccess, access)
              new PositivePatternCall(body, new FlatTuple(var_user, var_asset, var_operation, var__dominatedAccess, var_access), Domination_of_0QuerySpecification.instance().getInternalQueryRepresentation());
              bodies.add(body);
          }
