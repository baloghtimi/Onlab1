...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.strongConsequenceOnObject_at_1 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class StrongConsequenceOnObject_at_1Processor implements IMatchProcessor<StrongConsequenceOnObject_at_1Match> {
  /**
  ...
  @Override
  public void process(final StrongConsequenceOnObject_at_1Match match) {
