...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.dominationOnReference_of_default pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link DominationOnReference_of_defaultMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see DominationOnReference_of_defaultMatch
 *  @see DominationOnReference_of_defaultProcessor
 * @see DominationOnReference_of_defaultQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class DominationOnReference_of_defaultMatcher extends BaseMatcher<DominationOnReference_of_defaultMatch> {
  /**
   ...
   * 
   */
  public static DominationOnReference_of_defaultMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    DominationOnReference_of_defaultMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (DominationOnReference_of_defaultMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static DominationOnReference_of_defaultMatcher create() throws ViatraQueryException {
    return new DominationOnReference_of_defaultMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DominationOnReference_of_defaultMatcher.class);
   ...
   * 
   */
  private DominationOnReference_of_defaultMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a DominationOnReference_of_defaultMatch object.
   * 
   */
  public Collection<DominationOnReference_of_defaultMatch> getAllMatches(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation) {
   ...
   * @param pReference the fixed value of pattern parameter reference, or null if not bound.
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @return a match represented as a DominationOnReference_of_defaultMatch object, or null if no match is found.
   * 
   */
  public DominationOnReference_of_defaultMatch getOneArbitraryMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final IMatchProcessor<? super DominationOnReference_of_defaultMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final IMatchProcessor<? super DominationOnReference_of_defaultMatch> processor) {
   ...
   * 
   */
  public DominationOnReference_of_defaultMatch newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation) {
    return DominationOnReference_of_defaultMatch.newMatch(pUser, pSource, pTarget, pReference, pOperation);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final DominationOnReference_of_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfsource(final DominationOnReference_of_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOftarget(final DominationOnReference_of_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<EReference> getAllValuesOfreference(final DominationOnReference_of_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfoperation(final DominationOnReference_of_defaultMatch partialMatch) {
  ...
  @Override
  protected DominationOnReference_of_defaultMatch tupleToMatch(final Tuple t) {
    try {
        return DominationOnReference_of_defaultMatch.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_SOURCE), (EObject) t.get(POSITION_TARGET), (EReference) t.get(POSITION_REFERENCE), (Object) t.get(POSITION_OPERATION));
  ...
  @Override
  protected DominationOnReference_of_defaultMatch arrayToMatch(final Object[] match) {
    try {
        return DominationOnReference_of_defaultMatch.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (EObject) match[POSITION_TARGET], (EReference) match[POSITION_REFERENCE], (Object) match[POSITION_OPERATION]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected DominationOnReference_of_defaultMatch arrayToMatchMutable(final Object[] match) {
    try {
        return DominationOnReference_of_defaultMatch.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (EObject) match[POSITION_TARGET], (EReference) match[POSITION_REFERENCE], (Object) match[POSITION_OPERATION]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<DominationOnReference_of_defaultMatcher> querySpecification() throws ViatraQueryException {
