...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.referenceAsset pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class ReferenceAssetProcessor implements IMatchProcessor<ReferenceAssetMatch> {
  /**
  ...
  @Override
  public void process(final ReferenceAssetMatch match) {
