...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnObject pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link EffectiveJudgementOnObjectMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see EffectiveJudgementOnObjectMatch
 *  @see EffectiveJudgementOnObjectProcessor
 * @see EffectiveJudgementOnObjectQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class EffectiveJudgementOnObjectMatcher extends BaseMatcher<EffectiveJudgementOnObjectMatch> {
  /**
   ...
   * 
   */
  public static EffectiveJudgementOnObjectMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    EffectiveJudgementOnObjectMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (EffectiveJudgementOnObjectMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static EffectiveJudgementOnObjectMatcher create() throws ViatraQueryException {
    return new EffectiveJudgementOnObjectMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EffectiveJudgementOnObjectMatcher.class);
   ...
   * 
   */
  private EffectiveJudgementOnObjectMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a EffectiveJudgementOnObjectMatch object.
   * 
   */
  public Collection<EffectiveJudgementOnObjectMatch> getAllMatches(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a EffectiveJudgementOnObjectMatch object, or null if no match is found.
   * 
   */
  public EffectiveJudgementOnObjectMatch getOneArbitraryMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super EffectiveJudgementOnObjectMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super EffectiveJudgementOnObjectMatch> processor) {
   ...
   * 
   */
  public EffectiveJudgementOnObjectMatch newMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return EffectiveJudgementOnObjectMatch.newMatch(pUser, pObject, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final EffectiveJudgementOnObjectMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfobject(final EffectiveJudgementOnObjectMatch partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfoperation(final EffectiveJudgementOnObjectMatch partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfaccess(final EffectiveJudgementOnObjectMatch partialMatch) {
  ...
  @Override
  protected EffectiveJudgementOnObjectMatch tupleToMatch(final Tuple t) {
    try {
        return EffectiveJudgementOnObjectMatch.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_OBJECT), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_ACCESS));
  ...
  @Override
  protected EffectiveJudgementOnObjectMatch arrayToMatch(final Object[] match) {
    try {
        return EffectiveJudgementOnObjectMatch.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_OBJECT], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected EffectiveJudgementOnObjectMatch arrayToMatchMutable(final Object[] match) {
    try {
        return EffectiveJudgementOnObjectMatch.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_OBJECT], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<EffectiveJudgementOnObjectMatcher> querySpecification() throws ViatraQueryException {
