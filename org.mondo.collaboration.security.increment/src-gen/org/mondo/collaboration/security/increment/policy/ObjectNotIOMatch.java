...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.objectNotIO pattern,
 * to be used in conjunction with {@link ObjectNotIOMatcher}.
 * 
...
public abstract class ObjectNotIOMatch extends BasePatternMatch {
  private EObject fObject;
  
  private static List<String> parameterNames = makeImmutableList("object");
  
  private ObjectNotIOMatch(final EObject pObject) {
  ...
  public List<String> parameterNames() {
    return ObjectNotIOMatch.parameterNames;
  }
  ...
  @Override
  public ObjectNotIOMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof ObjectNotIOMatch)) {
        ObjectNotIOMatch other = (ObjectNotIOMatch) obj;
  ...
  @Override
  public ObjectNotIOQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ObjectNotIOMatch newEmptyMatch() {
   ...
   * 
   */
  public static ObjectNotIOMatch newMutableMatch(final EObject pObject) {
   ...
   * 
   */
  public static ObjectNotIOMatch newMatch(final EObject pObject) {
    return new Immutable(pObject);
  }
  
  private static final class Mutable extends ObjectNotIOMatch {
  ...
  private static final class Immutable extends ObjectNotIOMatch {
