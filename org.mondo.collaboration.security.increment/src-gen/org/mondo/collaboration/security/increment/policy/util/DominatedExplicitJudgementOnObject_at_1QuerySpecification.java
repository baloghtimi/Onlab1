...
/**
 * A pattern-specific query specification that can instantiate DominatedExplicitJudgementOnObject_at_1Matcher in a type-safe way.
 * 
...
public final class DominatedExplicitJudgementOnObject_at_1QuerySpecification extends BaseGeneratedEMFQuerySpecification<DominatedExplicitJudgementOnObject_at_1Matcher> {
  private DominatedExplicitJudgementOnObject_at_1QuerySpecification() {
   ...
   * 
   */
  public static DominatedExplicitJudgementOnObject_at_1QuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected DominatedExplicitJudgementOnObject_at_1Matcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return DominatedExplicitJudgementOnObject_at_1Matcher.on(engine);
  }
  
  @Override
  public DominatedExplicitJudgementOnObject_at_1Matcher instantiate() throws ViatraQueryException {
    return DominatedExplicitJudgementOnObject_at_1Matcher.create();
  }
  
  @Override
  public DominatedExplicitJudgementOnObject_at_1Match newEmptyMatch() {
    return DominatedExplicitJudgementOnObject_at_1Match.newEmptyMatch();
  }
  
  @Override
  public DominatedExplicitJudgementOnObject_at_1Match newMatch(final Object... parameters) {
    return DominatedExplicitJudgementOnObject_at_1Match.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (org.mondo.collaboration.policy.rules.OperationType) parameters[2], (org.mondo.collaboration.policy.rules.AccessibilityLevel) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnObject_at_1QuerySpecification (visibility: PUBLIC, simpleName: DominatedExplicitJudgementOnObject_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnObject_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnObject_at_1QuerySpecification (visibility: PUBLIC, simpleName: DominatedExplicitJudgementOnObject_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.DominatedExplicitJudgementOnObject_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static DominatedExplicitJudgementOnObject_at_1QuerySpecification INSTANCE = new DominatedExplicitJudgementOnObject_at_1QuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static DominatedExplicitJudgementOnObject_at_1QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
