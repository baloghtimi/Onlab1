...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.domination_by_1 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link Domination_by_1Match}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see Domination_by_1QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class Domination_by_1Matcher extends BaseMatcher<Domination_by_1Match> {
  /**
   ...
   * 
   */
  public static Domination_by_1Matcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    Domination_by_1Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (Domination_by_1Matcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static Domination_by_1Matcher create() throws ViatraQueryException {
    return new Domination_by_1Matcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Domination_by_1Matcher.class);
   ...
   * 
   */
  private Domination_by_1Matcher() throws ViatraQueryException {
   ...
   * @return matches represented as a Domination_by_1Match object.
   * 
   */
  public Collection<Domination_by_1Match> getAllMatches(final String pUser, final EObject pAsset, final Object pOperation, final AccessibilityLevel pDominatedAccess, final AccessibilityLevel pPrevailingAccess) {
   ...
   * @param pDominatedAccess the fixed value of pattern parameter dominatedAccess, or null if not bound.
   * @param pPrevailingAccess the fixed value of pattern parameter prevailingAccess, or null if not bound.
   * @return a match represented as a Domination_by_1Match object, or null if no match is found.
   * 
   */
  public Domination_by_1Match getOneArbitraryMatch(final String pUser, final EObject pAsset, final Object pOperation, final AccessibilityLevel pDominatedAccess, final AccessibilityLevel pPrevailingAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pAsset, final Object pOperation, final AccessibilityLevel pDominatedAccess, final AccessibilityLevel pPrevailingAccess, final IMatchProcessor<? super Domination_by_1Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pAsset, final Object pOperation, final AccessibilityLevel pDominatedAccess, final AccessibilityLevel pPrevailingAccess, final IMatchProcessor<? super Domination_by_1Match> processor) {
   ...
   * 
   */
  public Domination_by_1Match newMatch(final String pUser, final EObject pAsset, final Object pOperation, final AccessibilityLevel pDominatedAccess, final AccessibilityLevel pPrevailingAccess) {
    return Domination_by_1Match.newMatch(pUser, pAsset, pOperation, pDominatedAccess, pPrevailingAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final Domination_by_1Match partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfasset(final Domination_by_1Match partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfoperation(final Domination_by_1Match partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfdominatedAccess(final Domination_by_1Match partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfprevailingAccess(final Domination_by_1Match partialMatch) {
  ...
  @Override
  protected Domination_by_1Match tupleToMatch(final Tuple t) {
    try {
        return Domination_by_1Match.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_ASSET), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_DOMINATEDACCESS), (AccessibilityLevel) t.get(POSITION_PREVAILINGACCESS));
  ...
  @Override
  protected Domination_by_1Match arrayToMatch(final Object[] match) {
    try {
        return Domination_by_1Match.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_ASSET], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_DOMINATEDACCESS], (AccessibilityLevel) match[POSITION_PREVAILINGACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected Domination_by_1Match arrayToMatchMutable(final Object[] match) {
    try {
        return Domination_by_1Match.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_ASSET], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_DOMINATEDACCESS], (AccessibilityLevel) match[POSITION_PREVAILINGACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<Domination_by_1Matcher> querySpecification() throws ViatraQueryException {
