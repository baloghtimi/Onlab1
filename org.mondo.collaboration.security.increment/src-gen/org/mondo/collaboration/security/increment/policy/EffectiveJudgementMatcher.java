...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.effectiveJudgement pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link EffectiveJudgementMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 *  @see EffectiveJudgementProcessor
 * @see EffectiveJudgementQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class EffectiveJudgementMatcher extends BaseMatcher<EffectiveJudgementMatch> {
  /**
   ...
   * 
   */
  public static EffectiveJudgementMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    EffectiveJudgementMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (EffectiveJudgementMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static EffectiveJudgementMatcher create() throws ViatraQueryException {
    return new EffectiveJudgementMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EffectiveJudgementMatcher.class);
   ...
   * 
   */
  private EffectiveJudgementMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a EffectiveJudgementMatch object.
   * 
   */
  public Collection<EffectiveJudgementMatch> getAllMatches(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a EffectiveJudgementMatch object, or null if no match is found.
   * 
   */
  public EffectiveJudgementMatch getOneArbitraryMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess, final IMatchProcessor<? super EffectiveJudgementMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess, final IMatchProcessor<? super EffectiveJudgementMatch> processor) {
   ...
   * 
   */
  public EffectiveJudgementMatch newMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
    return EffectiveJudgementMatch.newMatch(pUser, pAsset, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final EffectiveJudgementMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfasset(final EffectiveJudgementMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfoperation(final EffectiveJudgementMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfaccess(final EffectiveJudgementMatch partialMatch) {
  ...
  @Override
  protected EffectiveJudgementMatch tupleToMatch(final Tuple t) {
    try {
        return EffectiveJudgementMatch.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_ASSET), (Object) t.get(POSITION_OPERATION), (Object) t.get(POSITION_ACCESS));
  ...
  @Override
  protected EffectiveJudgementMatch arrayToMatch(final Object[] match) {
    try {
        return EffectiveJudgementMatch.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_ASSET], (Object) match[POSITION_OPERATION], (Object) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected EffectiveJudgementMatch arrayToMatchMutable(final Object[] match) {
    try {
        return EffectiveJudgementMatch.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_ASSET], (Object) match[POSITION_OPERATION], (Object) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<EffectiveJudgementMatcher> querySpecification() throws ViatraQueryException {
