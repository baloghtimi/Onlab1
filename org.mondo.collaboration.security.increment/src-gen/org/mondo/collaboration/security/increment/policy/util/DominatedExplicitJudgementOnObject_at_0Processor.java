...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.dominatedExplicitJudgementOnObject_at_0 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class DominatedExplicitJudgementOnObject_at_0Processor implements IMatchProcessor<DominatedExplicitJudgementOnObject_at_0Match> {
  /**
  ...
  @Override
  public void process(final DominatedExplicitJudgementOnObject_at_0Match match) {
