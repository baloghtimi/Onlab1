...
/**
 * A pattern-specific query specification that can instantiate ReferenceitsParamsMatcher in a type-safe way.
 * 
...
public final class ReferenceitsParamsQuerySpecification extends BaseGeneratedEMFQuerySpecification<ReferenceitsParamsMatcher> {
  private ReferenceitsParamsQuerySpecification() {
   ...
   * 
   */
  public static ReferenceitsParamsQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected ReferenceitsParamsMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return ReferenceitsParamsMatcher.on(engine);
  }
  
  @Override
  public ReferenceitsParamsMatcher instantiate() throws ViatraQueryException {
    return ReferenceitsParamsMatcher.create();
  }
  
  @Override
  public ReferenceitsParamsMatch newEmptyMatch() {
    return ReferenceitsParamsMatch.newEmptyMatch();
  }
  
  @Override
  public ReferenceitsParamsMatch newMatch(final Object... parameters) {
    return ReferenceitsParamsMatch.newMatch((WTSpec4M.WT) parameters[0], (WTSpec4M.SystemParam) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.ReferenceitsParamsQuerySpecification (visibility: PUBLIC, simpleName: ReferenceitsParamsQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.ReferenceitsParamsQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.ReferenceitsParamsQuerySpecification (visibility: PUBLIC, simpleName: ReferenceitsParamsQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.ReferenceitsParamsQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static ReferenceitsParamsQuerySpecification INSTANCE = new ReferenceitsParamsQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ReferenceitsParamsQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pRoot, parameter_pParam);
    ...
    public List<String> getParameterNames() {
      return Arrays.asList("root","param");
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      Set<PBody> bodies = Sets.newLinkedHashSet();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_root, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://WTSpec4M/5.0M", "WT", "itsParams")));
