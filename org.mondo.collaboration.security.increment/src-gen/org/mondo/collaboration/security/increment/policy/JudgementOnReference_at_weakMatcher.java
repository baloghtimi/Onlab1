...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.judgementOnReference_at_weak pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link JudgementOnReference_at_weakMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 *  @see JudgementOnReference_at_weakProcessor
 * @see JudgementOnReference_at_weakQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class JudgementOnReference_at_weakMatcher extends BaseMatcher<JudgementOnReference_at_weakMatch> {
  /**
   ...
   * 
   */
  public static JudgementOnReference_at_weakMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    JudgementOnReference_at_weakMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (JudgementOnReference_at_weakMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static JudgementOnReference_at_weakMatcher create() throws ViatraQueryException {
    return new JudgementOnReference_at_weakMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(JudgementOnReference_at_weakMatcher.class);
   ...
   * 
   */
  private JudgementOnReference_at_weakMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a JudgementOnReference_at_weakMatch object.
   * 
   */
  public Collection<JudgementOnReference_at_weakMatch> getAllMatches(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a JudgementOnReference_at_weakMatch object, or null if no match is found.
   * 
   */
  public JudgementOnReference_at_weakMatch getOneArbitraryMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess, final IMatchProcessor<? super JudgementOnReference_at_weakMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess, final IMatchProcessor<? super JudgementOnReference_at_weakMatch> processor) {
   ...
   * 
   */
  public JudgementOnReference_at_weakMatch newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess) {
    return JudgementOnReference_at_weakMatch.newMatch(pUser, pSource, pTarget, pReference, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final JudgementOnReference_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfsource(final JudgementOnReference_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOftarget(final JudgementOnReference_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<EReference> getAllValuesOfreference(final JudgementOnReference_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfoperation(final JudgementOnReference_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfaccess(final JudgementOnReference_at_weakMatch partialMatch) {
  ...
  @Override
  protected JudgementOnReference_at_weakMatch tupleToMatch(final Tuple t) {
    try {
        return JudgementOnReference_at_weakMatch.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_SOURCE), (EObject) t.get(POSITION_TARGET), (EReference) t.get(POSITION_REFERENCE), (Object) t.get(POSITION_OPERATION), (Object) t.get(POSITION_ACCESS));
  ...
  @Override
  protected JudgementOnReference_at_weakMatch arrayToMatch(final Object[] match) {
    try {
        return JudgementOnReference_at_weakMatch.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (EObject) match[POSITION_TARGET], (EReference) match[POSITION_REFERENCE], (Object) match[POSITION_OPERATION], (Object) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected JudgementOnReference_at_weakMatch arrayToMatchMutable(final Object[] match) {
    try {
        return JudgementOnReference_at_weakMatch.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (EObject) match[POSITION_TARGET], (EReference) match[POSITION_REFERENCE], (Object) match[POSITION_OPERATION], (Object) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<JudgementOnReference_at_weakMatcher> querySpecification() throws ViatraQueryException {
