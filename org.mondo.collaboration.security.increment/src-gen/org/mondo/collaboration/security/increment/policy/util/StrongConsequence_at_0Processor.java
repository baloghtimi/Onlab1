...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.strongConsequence_at_0 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class StrongConsequence_at_0Processor implements IMatchProcessor<StrongConsequence_at_0Match> {
  /**
  ...
  @Override
  public void process(final StrongConsequence_at_0Match match) {
