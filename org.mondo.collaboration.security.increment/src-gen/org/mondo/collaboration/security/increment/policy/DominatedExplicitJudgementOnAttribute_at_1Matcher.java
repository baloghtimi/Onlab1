...
import org.mondo.collaboration.security.increment.policy.DominatedExplicitJudgementOnAttribute_at_1Match;
...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.dominatedExplicitJudgementOnAttribute_at_1 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link DominatedExplicitJudgementOnAttribute_at_1Match}.
 * 
 * <p>Original source:
 * <code><pre>
 * pattern dominatedExplicitJudgementOnAttribute_at_1(user: java String, source: EObject, value: java Object, attribute: EAttribute, operation, prevailingAccess) 
 * {
 ...
 * </pre></code>
 * 
 * @see DominatedExplicitJudgementOnAttribute_at_1Match
 *  @see DominatedExplicitJudgementOnAttribute_at_1Processor
 * @see DominatedExplicitJudgementOnAttribute_at_1QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class DominatedExplicitJudgementOnAttribute_at_1Matcher extends BaseMatcher<DominatedExplicitJudgementOnAttribute_at_1Match> {
  /**
   ...
   * 
   */
  public static DominatedExplicitJudgementOnAttribute_at_1Matcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    DominatedExplicitJudgementOnAttribute_at_1Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (DominatedExplicitJudgementOnAttribute_at_1Matcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static DominatedExplicitJudgementOnAttribute_at_1Matcher create() throws ViatraQueryException {
    return new DominatedExplicitJudgementOnAttribute_at_1Matcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DominatedExplicitJudgementOnAttribute_at_1Matcher.class);
   ...
   * 
   */
  private DominatedExplicitJudgementOnAttribute_at_1Matcher() throws ViatraQueryException {
   ...
   * @return matches represented as a DominatedExplicitJudgementOnAttribute_at_1Match object.
   * 
   */
  public Collection<DominatedExplicitJudgementOnAttribute_at_1Match> getAllMatches(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pPrevailingAccess the fixed value of pattern parameter prevailingAccess, or null if not bound.
   * @return a match represented as a DominatedExplicitJudgementOnAttribute_at_1Match object, or null if no match is found.
   * 
   */
  public DominatedExplicitJudgementOnAttribute_at_1Match getOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess, final IMatchProcessor<? super DominatedExplicitJudgementOnAttribute_at_1Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess, final IMatchProcessor<? super DominatedExplicitJudgementOnAttribute_at_1Match> processor) {
   ...
   * 
   */
  public DominatedExplicitJudgementOnAttribute_at_1Match newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pPrevailingAccess) {
    return DominatedExplicitJudgementOnAttribute_at_1Match.newMatch(pUser, pSource, pValue, pAttribute, pOperation, pPrevailingAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final DominatedExplicitJudgementOnAttribute_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfsource(final DominatedExplicitJudgementOnAttribute_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfvalue(final DominatedExplicitJudgementOnAttribute_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<EAttribute> getAllValuesOfattribute(final DominatedExplicitJudgementOnAttribute_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfoperation(final DominatedExplicitJudgementOnAttribute_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfprevailingAccess(final DominatedExplicitJudgementOnAttribute_at_1Match partialMatch) {
  ...
  @Override
  protected DominatedExplicitJudgementOnAttribute_at_1Match tupleToMatch(final Tuple t) {
    try {
        return DominatedExplicitJudgementOnAttribute_at_1Match.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_SOURCE), (Object) t.get(POSITION_VALUE), (EAttribute) t.get(POSITION_ATTRIBUTE), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_PREVAILINGACCESS));
  ...
  @Override
  protected DominatedExplicitJudgementOnAttribute_at_1Match arrayToMatch(final Object[] match) {
    try {
        return DominatedExplicitJudgementOnAttribute_at_1Match.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_PREVAILINGACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected DominatedExplicitJudgementOnAttribute_at_1Match arrayToMatchMutable(final Object[] match) {
    try {
        return DominatedExplicitJudgementOnAttribute_at_1Match.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_PREVAILINGACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<DominatedExplicitJudgementOnAttribute_at_1Matcher> querySpecification() throws ViatraQueryException {
