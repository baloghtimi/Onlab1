...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnReference_at_1 pattern,
 * to be used in conjunction with {@link EffectiveJudgementOnReference_at_1Matcher}.
 * 
...
public abstract class EffectiveJudgementOnReference_at_1Match extends BasePatternMatch {
  ...
  private EffectiveJudgementOnReference_at_1Match(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return EffectiveJudgementOnReference_at_1Match.parameterNames;
  }
  ...
  @Override
  public EffectiveJudgementOnReference_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof EffectiveJudgementOnReference_at_1Match)) {
        EffectiveJudgementOnReference_at_1Match other = (EffectiveJudgementOnReference_at_1Match) obj;
  ...
  @Override
  public EffectiveJudgementOnReference_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EffectiveJudgementOnReference_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static EffectiveJudgementOnReference_at_1Match newMutableMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static EffectiveJudgementOnReference_at_1Match newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pTarget, pReference, pOperation, pAccess);
  }
  
  private static final class Mutable extends EffectiveJudgementOnReference_at_1Match {
  ...
  private static final class Immutable extends EffectiveJudgementOnReference_at_1Match {
