...
public class EffectiveJudgementOnReference_at_weakMatcher extends BaseMatcher<EffectiveJudgementOnReference_at_weakMatch> {
   ...
   * 
   */
  public Collection<EffectiveJudgementOnReference_at_weakMatch> getAllMatches(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public EffectiveJudgementOnReference_at_weakMatch getOneArbitraryMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super EffectiveJudgementOnReference_at_weakMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super EffectiveJudgementOnReference_at_weakMatch> processor) {
   ...
   * 
   */
  public EffectiveJudgementOnReference_at_weakMatch newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfoperation(final EffectiveJudgementOnReference_at_weakMatch partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfaccess(final EffectiveJudgementOnReference_at_weakMatch partialMatch) {
