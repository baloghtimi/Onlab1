...
/**
 * A pattern-specific query specification that can instantiate DominationOnAttribute_of_weakMatcher in a type-safe way.
 * 
...
public final class DominationOnAttribute_of_weakQuerySpecification extends BaseGeneratedEMFQuerySpecification<DominationOnAttribute_of_weakMatcher> {
  private DominationOnAttribute_of_weakQuerySpecification() {
   ...
   * 
   */
  public static DominationOnAttribute_of_weakQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected DominationOnAttribute_of_weakMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return DominationOnAttribute_of_weakMatcher.on(engine);
  }
  
  @Override
  public DominationOnAttribute_of_weakMatcher instantiate() throws ViatraQueryException {
    return DominationOnAttribute_of_weakMatcher.create();
  }
  
  @Override
  public DominationOnAttribute_of_weakMatch newEmptyMatch() {
    return DominationOnAttribute_of_weakMatch.newEmptyMatch();
  }
  
  @Override
  public DominationOnAttribute_of_weakMatch newMatch(final Object... parameters) {
    return DominationOnAttribute_of_weakMatch.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (java.lang.Object) parameters[2], (org.eclipse.emf.ecore.EAttribute) parameters[3], (java.lang.Object) parameters[4]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.DominationOnAttribute_of_weakQuerySpecification (visibility: PUBLIC, simpleName: DominationOnAttribute_of_weakQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.DominationOnAttribute_of_weakQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.DominationOnAttribute_of_weakQuerySpecification (visibility: PUBLIC, simpleName: DominationOnAttribute_of_weakQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.DominationOnAttribute_of_weakQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static DominationOnAttribute_of_weakQuerySpecification INSTANCE = new DominationOnAttribute_of_weakQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static DominationOnAttribute_of_weakQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
