...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.strongConsequence_at_1 pattern,
 * to be used in conjunction with {@link StrongConsequence_at_1Matcher}.
 * 
...
public abstract class StrongConsequence_at_1Match extends BasePatternMatch {
  ...
  private StrongConsequence_at_1Match(final String pUser, final EObject pDepAsset, final OperationType pDepOp, final AccessibilityLevel pDepAccess, final EObject pDomAsset, final OperationType pDomOp, final AccessibilityLevel pDomAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return StrongConsequence_at_1Match.parameterNames;
  }
  ...
  @Override
  public StrongConsequence_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof StrongConsequence_at_1Match)) {
        StrongConsequence_at_1Match other = (StrongConsequence_at_1Match) obj;
  ...
  @Override
  public StrongConsequence_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static StrongConsequence_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static StrongConsequence_at_1Match newMutableMatch(final String pUser, final EObject pDepAsset, final OperationType pDepOp, final AccessibilityLevel pDepAccess, final EObject pDomAsset, final OperationType pDomOp, final AccessibilityLevel pDomAccess) {
   ...
   * 
   */
  public static StrongConsequence_at_1Match newMatch(final String pUser, final EObject pDepAsset, final OperationType pDepOp, final AccessibilityLevel pDepAccess, final EObject pDomAsset, final OperationType pDomOp, final AccessibilityLevel pDomAccess) {
    return new Immutable(pUser, pDepAsset, pDepOp, pDepAccess, pDomAsset, pDomOp, pDomAccess);
  }
  
  private static final class Mutable extends StrongConsequence_at_1Match {
  ...
  private static final class Immutable extends StrongConsequence_at_1Match {
