...
public class EffectiveJudgementOnReference_at_1Matcher extends BaseMatcher<EffectiveJudgementOnReference_at_1Match> {
   ...
   * 
   */
  public Collection<EffectiveJudgementOnReference_at_1Match> getAllMatches(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public EffectiveJudgementOnReference_at_1Match getOneArbitraryMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess, final IMatchProcessor<? super EffectiveJudgementOnReference_at_1Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess, final IMatchProcessor<? super EffectiveJudgementOnReference_at_1Match> processor) {
   ...
   * 
   */
  public EffectiveJudgementOnReference_at_1Match newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfoperation(final EffectiveJudgementOnReference_at_1Match partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfaccess(final EffectiveJudgementOnReference_at_1Match partialMatch) {
