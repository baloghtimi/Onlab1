...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.weakConsequenceOnReference pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class WeakConsequenceOnReferenceProcessor implements IMatchProcessor<WeakConsequenceOnReferenceMatch> {
  /**
  ...
  @Override
  public void process(final WeakConsequenceOnReferenceMatch match) {
