...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.weakConsequenceOnAttribute pattern,
 * to be used in conjunction with {@link WeakConsequenceOnAttributeMatcher}.
 * 
...
public abstract class WeakConsequenceOnAttributeMatch extends BasePatternMatch {
  ...
  private WeakConsequenceOnAttributeMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation, final Object pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return WeakConsequenceOnAttributeMatch.parameterNames;
  }
  ...
  @Override
  public WeakConsequenceOnAttributeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof WeakConsequenceOnAttributeMatch)) {
        WeakConsequenceOnAttributeMatch other = (WeakConsequenceOnAttributeMatch) obj;
  ...
  @Override
  public WeakConsequenceOnAttributeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static WeakConsequenceOnAttributeMatch newEmptyMatch() {
   ...
   * 
   */
  public static WeakConsequenceOnAttributeMatch newMutableMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public static WeakConsequenceOnAttributeMatch newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation, final Object pAccess) {
    return new Immutable(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
  
  private static final class Mutable extends WeakConsequenceOnAttributeMatch {
  ...
  private static final class Immutable extends WeakConsequenceOnAttributeMatch {
