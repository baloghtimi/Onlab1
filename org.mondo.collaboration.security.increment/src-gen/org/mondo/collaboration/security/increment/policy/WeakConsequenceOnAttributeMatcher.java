...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.weakConsequenceOnAttribute pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link WeakConsequenceOnAttributeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 *  @see WeakConsequenceOnAttributeProcessor
 * @see WeakConsequenceOnAttributeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class WeakConsequenceOnAttributeMatcher extends BaseMatcher<WeakConsequenceOnAttributeMatch> {
  /**
   ...
   * 
   */
  public static WeakConsequenceOnAttributeMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    WeakConsequenceOnAttributeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (WeakConsequenceOnAttributeMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static WeakConsequenceOnAttributeMatcher create() throws ViatraQueryException {
    return new WeakConsequenceOnAttributeMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WeakConsequenceOnAttributeMatcher.class);
   ...
   * 
   */
  private WeakConsequenceOnAttributeMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a WeakConsequenceOnAttributeMatch object.
   * 
   */
  public Collection<WeakConsequenceOnAttributeMatch> getAllMatches(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation, final Object pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a WeakConsequenceOnAttributeMatch object, or null if no match is found.
   * 
   */
  public WeakConsequenceOnAttributeMatch getOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation, final Object pAccess, final IMatchProcessor<? super WeakConsequenceOnAttributeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation, final Object pAccess, final IMatchProcessor<? super WeakConsequenceOnAttributeMatch> processor) {
   ...
   * 
   */
  public WeakConsequenceOnAttributeMatch newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final Object pOperation, final Object pAccess) {
    return WeakConsequenceOnAttributeMatch.newMatch(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final WeakConsequenceOnAttributeMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfsource(final WeakConsequenceOnAttributeMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfvalue(final WeakConsequenceOnAttributeMatch partialMatch) {
   ...
   * 
   */
  public Set<EAttribute> getAllValuesOfattribute(final WeakConsequenceOnAttributeMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfoperation(final WeakConsequenceOnAttributeMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfaccess(final WeakConsequenceOnAttributeMatch partialMatch) {
  ...
  @Override
  protected WeakConsequenceOnAttributeMatch tupleToMatch(final Tuple t) {
    try {
        return WeakConsequenceOnAttributeMatch.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_SOURCE), (Object) t.get(POSITION_VALUE), (EAttribute) t.get(POSITION_ATTRIBUTE), (Object) t.get(POSITION_OPERATION), (Object) t.get(POSITION_ACCESS));
  ...
  @Override
  protected WeakConsequenceOnAttributeMatch arrayToMatch(final Object[] match) {
    try {
        return WeakConsequenceOnAttributeMatch.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (Object) match[POSITION_OPERATION], (Object) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected WeakConsequenceOnAttributeMatch arrayToMatchMutable(final Object[] match) {
    try {
        return WeakConsequenceOnAttributeMatch.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_SOURCE], (Object) match[POSITION_VALUE], (EAttribute) match[POSITION_ATTRIBUTE], (Object) match[POSITION_OPERATION], (Object) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<WeakConsequenceOnAttributeMatcher> querySpecification() throws ViatraQueryException {
