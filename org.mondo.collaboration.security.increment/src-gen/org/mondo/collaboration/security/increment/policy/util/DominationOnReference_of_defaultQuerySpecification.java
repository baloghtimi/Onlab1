...
/**
 * A pattern-specific query specification that can instantiate DominationOnReference_of_defaultMatcher in a type-safe way.
 * 
 * @see DominationOnReference_of_defaultMatcher
 * @see DominationOnReference_of_defaultMatch
 * 
 */
@SuppressWarnings("all")
public final class DominationOnReference_of_defaultQuerySpecification extends BaseGeneratedEMFQuerySpecification<DominationOnReference_of_defaultMatcher> {
  private DominationOnReference_of_defaultQuerySpecification() {
   ...
   * 
   */
  public static DominationOnReference_of_defaultQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected DominationOnReference_of_defaultMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return DominationOnReference_of_defaultMatcher.on(engine);
  }
  
  @Override
  public DominationOnReference_of_defaultMatcher instantiate() throws ViatraQueryException {
    return DominationOnReference_of_defaultMatcher.create();
  }
  
  @Override
  public DominationOnReference_of_defaultMatch newEmptyMatch() {
    return DominationOnReference_of_defaultMatch.newEmptyMatch();
  }
  
  @Override
  public DominationOnReference_of_defaultMatch newMatch(final Object... parameters) {
    return DominationOnReference_of_defaultMatch.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (org.eclipse.emf.ecore.EObject) parameters[2], (org.eclipse.emf.ecore.EReference) parameters[3], (java.lang.Object) parameters[4]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.DominationOnReference_of_defaultQuerySpecification (visibility: PUBLIC, simpleName: DominationOnReference_of_defaultQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.DominationOnReference_of_defaultQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.DominationOnReference_of_defaultQuerySpecification (visibility: PUBLIC, simpleName: DominationOnReference_of_defaultQuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.DominationOnReference_of_defaultQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static DominationOnReference_of_defaultQuerySpecification INSTANCE = new DominationOnReference_of_defaultQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static DominationOnReference_of_defaultQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.security.increment.policy.dominationOnReference_of_default";
    }
      ...
      try {
          {
              ...
              new PositivePatternCall(body, new FlatTuple(var_user, var_source, var_target, var_reference, var_operation, var__access), EffectiveJudgementOnReference_at_weakQuerySpecification.instance().getInternalQueryRepresentation());
              bodies.add(body);
          }
          {
              PBody body = new PBody(this);
