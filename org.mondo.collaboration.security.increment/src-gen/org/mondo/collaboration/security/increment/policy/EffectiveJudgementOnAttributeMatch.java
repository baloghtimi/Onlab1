...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnAttribute pattern,
 * to be used in conjunction with {@link EffectiveJudgementOnAttributeMatcher}.
 * 
...
public abstract class EffectiveJudgementOnAttributeMatch extends BasePatternMatch {
  ...
  private EffectiveJudgementOnAttributeMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return EffectiveJudgementOnAttributeMatch.parameterNames;
  }
  ...
  @Override
  public EffectiveJudgementOnAttributeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof EffectiveJudgementOnAttributeMatch)) {
        EffectiveJudgementOnAttributeMatch other = (EffectiveJudgementOnAttributeMatch) obj;
  ...
  @Override
  public EffectiveJudgementOnAttributeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EffectiveJudgementOnAttributeMatch newEmptyMatch() {
   ...
   * 
   */
  public static EffectiveJudgementOnAttributeMatch newMutableMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static EffectiveJudgementOnAttributeMatch newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
  
  private static final class Mutable extends EffectiveJudgementOnAttributeMatch {
  ...
  private static final class Immutable extends EffectiveJudgementOnAttributeMatch {
