...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.enableRootUser pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class EnableRootUserProcessor implements IMatchProcessor<EnableRootUserMatch> {
  /**
  ...
  @Override
  public void process(final EnableRootUserMatch match) {
