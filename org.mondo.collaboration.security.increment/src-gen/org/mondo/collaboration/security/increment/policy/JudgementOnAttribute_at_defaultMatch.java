...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.judgementOnAttribute_at_default pattern,
 * to be used in conjunction with {@link JudgementOnAttribute_at_defaultMatcher}.
 * 
...
public abstract class JudgementOnAttribute_at_defaultMatch extends BasePatternMatch {
  ...
  private JudgementOnAttribute_at_defaultMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return JudgementOnAttribute_at_defaultMatch.parameterNames;
  }
  ...
  @Override
  public JudgementOnAttribute_at_defaultMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof JudgementOnAttribute_at_defaultMatch)) {
        JudgementOnAttribute_at_defaultMatch other = (JudgementOnAttribute_at_defaultMatch) obj;
  ...
  @Override
  public JudgementOnAttribute_at_defaultQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JudgementOnAttribute_at_defaultMatch newEmptyMatch() {
   ...
   * 
   */
  public static JudgementOnAttribute_at_defaultMatch newMutableMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static JudgementOnAttribute_at_defaultMatch newMatch(final String pUser, final EObject pSource, final Object pValue, final EAttribute pAttribute, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pValue, pAttribute, pOperation, pAccess);
  }
  
  private static final class Mutable extends JudgementOnAttribute_at_defaultMatch {
  ...
  private static final class Immutable extends JudgementOnAttribute_at_defaultMatch {
