...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.containmentReference pattern,
 * to be used in conjunction with {@link ContainmentReferenceMatcher}.
 * 
...
public abstract class ContainmentReferenceMatch extends BasePatternMatch {
  ...
  private ContainmentReferenceMatch(final EObject pSource, final EObject pTarget, final EReference pReference) {
  ...
  public List<String> parameterNames() {
    return ContainmentReferenceMatch.parameterNames;
  }
  ...
  @Override
  public ContainmentReferenceMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof ContainmentReferenceMatch)) {
        ContainmentReferenceMatch other = (ContainmentReferenceMatch) obj;
  ...
  @Override
  public ContainmentReferenceQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ContainmentReferenceMatch newEmptyMatch() {
   ...
   * 
   */
  public static ContainmentReferenceMatch newMutableMatch(final EObject pSource, final EObject pTarget, final EReference pReference) {
   ...
   * 
   */
  public static ContainmentReferenceMatch newMatch(final EObject pSource, final EObject pTarget, final EReference pReference) {
    return new Immutable(pSource, pTarget, pReference);
  }
  
  private static final class Mutable extends ContainmentReferenceMatch {
  ...
  private static final class Immutable extends ContainmentReferenceMatch {
