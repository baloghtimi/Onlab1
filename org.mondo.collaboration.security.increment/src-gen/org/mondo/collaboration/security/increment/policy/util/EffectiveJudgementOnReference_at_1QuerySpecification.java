...
import org.mondo.collaboration.security.increment.policy.util.DominatedJudgementOnReferenceBySamePriority_at_1QuerySpecification;
import org.mondo.collaboration.security.increment.policy.util.JudgementOnReference_at_1QuerySpecification;

/**
 * A pattern-specific query specification that can instantiate EffectiveJudgementOnReference_at_1Matcher in a type-safe way.
 * 
 * @see EffectiveJudgementOnReference_at_1Matcher
 * @see EffectiveJudgementOnReference_at_1Match
 * 
 */
@SuppressWarnings("all")
public final class EffectiveJudgementOnReference_at_1QuerySpecification extends BaseGeneratedEMFQuerySpecification<EffectiveJudgementOnReference_at_1Matcher> {
  private EffectiveJudgementOnReference_at_1QuerySpecification() {
   ...
   * 
   */
  public static EffectiveJudgementOnReference_at_1QuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected EffectiveJudgementOnReference_at_1Matcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return EffectiveJudgementOnReference_at_1Matcher.on(engine);
  }
  
  @Override
  public EffectiveJudgementOnReference_at_1Matcher instantiate() throws ViatraQueryException {
    return EffectiveJudgementOnReference_at_1Matcher.create();
  }
  
  @Override
  public EffectiveJudgementOnReference_at_1Match newEmptyMatch() {
    return EffectiveJudgementOnReference_at_1Match.newEmptyMatch();
  }
  
  @Override
  public EffectiveJudgementOnReference_at_1Match newMatch(final Object... parameters) {
    return EffectiveJudgementOnReference_at_1Match.newMatch((java.lang.String) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1], (org.eclipse.emf.ecore.EObject) parameters[2], (org.eclipse.emf.ecore.EReference) parameters[3], (org.mondo.collaboration.policy.rules.OperationType) parameters[4], (org.mondo.collaboration.policy.rules.AccessibilityLevel) parameters[5]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.EffectiveJudgementOnReference_at_1QuerySpecification (visibility: PUBLIC, simpleName: EffectiveJudgementOnReference_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.EffectiveJudgementOnReference_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.mondo.collaboration.security.increment.policy.util.EffectiveJudgementOnReference_at_1QuerySpecification (visibility: PUBLIC, simpleName: EffectiveJudgementOnReference_at_1QuerySpecification, identifier: org.mondo.collaboration.security.increment.policy.util.EffectiveJudgementOnReference_at_1QuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.mondo.collaboration.security.increment.policy.util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static EffectiveJudgementOnReference_at_1QuerySpecification INSTANCE = new EffectiveJudgementOnReference_at_1QuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static EffectiveJudgementOnReference_at_1QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.security.increment.policy.effectiveJudgementOnReference_at_1";
    }
      ...
      try {
          {
              ...
              new PositivePatternCall(body, new FlatTuple(var_user, var_source, var_target, var_reference, var_operation, var_access), JudgementOnReference_at_1QuerySpecification.instance().getInternalQueryRepresentation());
              //     neg find dominatedJudgementOnReferenceBySamePriority_at_1(user, source, target, reference, operation, access)
              new NegativePatternCall(body, new FlatTuple(var_user, var_source, var_target, var_reference, var_operation, var_access), DominatedJudgementOnReferenceBySamePriority_at_1QuerySpecification.instance().getInternalQueryRepresentation());
              bodies.add(body);
          }
