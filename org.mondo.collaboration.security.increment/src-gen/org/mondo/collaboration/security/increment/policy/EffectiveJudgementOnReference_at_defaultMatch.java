...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.effectiveJudgementOnReference_at_default pattern,
 * to be used in conjunction with {@link EffectiveJudgementOnReference_at_defaultMatcher}.
 * 
...
public abstract class EffectiveJudgementOnReference_at_defaultMatch extends BasePatternMatch {
  ...
  private EffectiveJudgementOnReference_at_defaultMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return EffectiveJudgementOnReference_at_defaultMatch.parameterNames;
  }
  ...
  @Override
  public EffectiveJudgementOnReference_at_defaultMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof EffectiveJudgementOnReference_at_defaultMatch)) {
        EffectiveJudgementOnReference_at_defaultMatch other = (EffectiveJudgementOnReference_at_defaultMatch) obj;
  ...
  @Override
  public EffectiveJudgementOnReference_at_defaultQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EffectiveJudgementOnReference_at_defaultMatch newEmptyMatch() {
   ...
   * 
   */
  public static EffectiveJudgementOnReference_at_defaultMatch newMutableMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static EffectiveJudgementOnReference_at_defaultMatch newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pTarget, pReference, pOperation, pAccess);
  }
  
  private static final class Mutable extends EffectiveJudgementOnReference_at_defaultMatch {
  ...
  private static final class Immutable extends EffectiveJudgementOnReference_at_defaultMatch {
