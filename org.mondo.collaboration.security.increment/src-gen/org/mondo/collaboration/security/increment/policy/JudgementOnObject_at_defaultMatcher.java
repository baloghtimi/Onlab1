...
import org.mondo.collaboration.security.increment.policy.JudgementOnObject_at_defaultMatch;
import org.mondo.collaboration.security.increment.policy.util.JudgementOnObject_at_defaultQuerySpecification;

/**
 * Generated pattern matcher API of the org.mondo.collaboration.security.increment.policy.judgementOnObject_at_default pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link JudgementOnObject_at_defaultMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see JudgementOnObject_at_defaultMatch
 *  @see JudgementOnObject_at_defaultProcessor
 * @see JudgementOnObject_at_defaultQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class JudgementOnObject_at_defaultMatcher extends BaseMatcher<JudgementOnObject_at_defaultMatch> {
  /**
   ...
   * 
   */
  public static JudgementOnObject_at_defaultMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    JudgementOnObject_at_defaultMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (JudgementOnObject_at_defaultMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static JudgementOnObject_at_defaultMatcher create() throws ViatraQueryException {
    return new JudgementOnObject_at_defaultMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(JudgementOnObject_at_defaultMatcher.class);
   ...
   * 
   */
  private JudgementOnObject_at_defaultMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a JudgementOnObject_at_defaultMatch object.
   * 
   */
  public Collection<JudgementOnObject_at_defaultMatch> getAllMatches(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * @param pOperation the fixed value of pattern parameter operation, or null if not bound.
   * @param pAccess the fixed value of pattern parameter access, or null if not bound.
   * @return a match represented as a JudgementOnObject_at_defaultMatch object, or null if no match is found.
   * 
   */
  public JudgementOnObject_at_defaultMatch getOneArbitraryMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public void forEachMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super JudgementOnObject_at_defaultMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess, final IMatchProcessor<? super JudgementOnObject_at_defaultMatch> processor) {
   ...
   * 
   */
  public JudgementOnObject_at_defaultMatch newMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return JudgementOnObject_at_defaultMatch.newMatch(pUser, pObject, pOperation, pAccess);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfuser(final JudgementOnObject_at_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOfobject(final JudgementOnObject_at_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<OperationType> getAllValuesOfoperation(final JudgementOnObject_at_defaultMatch partialMatch) {
   ...
   * 
   */
  public Set<AccessibilityLevel> getAllValuesOfaccess(final JudgementOnObject_at_defaultMatch partialMatch) {
  ...
  @Override
  protected JudgementOnObject_at_defaultMatch tupleToMatch(final Tuple t) {
    try {
        return JudgementOnObject_at_defaultMatch.newMatch((String) t.get(POSITION_USER), (EObject) t.get(POSITION_OBJECT), (OperationType) t.get(POSITION_OPERATION), (AccessibilityLevel) t.get(POSITION_ACCESS));
  ...
  @Override
  protected JudgementOnObject_at_defaultMatch arrayToMatch(final Object[] match) {
    try {
        return JudgementOnObject_at_defaultMatch.newMatch((String) match[POSITION_USER], (EObject) match[POSITION_OBJECT], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected JudgementOnObject_at_defaultMatch arrayToMatchMutable(final Object[] match) {
    try {
        return JudgementOnObject_at_defaultMatch.newMutableMatch((String) match[POSITION_USER], (EObject) match[POSITION_OBJECT], (OperationType) match[POSITION_OPERATION], (AccessibilityLevel) match[POSITION_ACCESS]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<JudgementOnObject_at_defaultMatcher> querySpecification() throws ViatraQueryException {
