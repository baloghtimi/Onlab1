...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.enableRootUser pattern,
 * to be used in conjunction with {@link EnableRootUserMatcher}.
 * 
...
public abstract class EnableRootUserMatch extends BasePatternMatch {
  private String fUser;
  
  private static List<String> parameterNames = makeImmutableList("user");
  
  private EnableRootUserMatch(final String pUser) {
    this.fUser = pUser;
  }
  ...
  public List<String> parameterNames() {
    return EnableRootUserMatch.parameterNames;
  }
  ...
  @Override
  public EnableRootUserMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof EnableRootUserMatch)) {
        EnableRootUserMatch other = (EnableRootUserMatch) obj;
  ...
  @Override
  public EnableRootUserQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EnableRootUserMatch newEmptyMatch() {
   ...
   * 
   */
  public static EnableRootUserMatch newMutableMatch(final String pUser) {
   ...
   * 
   */
  public static EnableRootUserMatch newMatch(final String pUser) {
    return new Immutable(pUser);
  }
  
  private static final class Mutable extends EnableRootUserMatch {
  ...
  private static final class Immutable extends EnableRootUserMatch {
