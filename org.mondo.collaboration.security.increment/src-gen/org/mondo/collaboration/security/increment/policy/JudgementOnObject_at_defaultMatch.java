...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.judgementOnObject_at_default pattern,
 * to be used in conjunction with {@link JudgementOnObject_at_defaultMatcher}.
 * 
...
public abstract class JudgementOnObject_at_defaultMatch extends BasePatternMatch {
  ...
  private JudgementOnObject_at_defaultMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return JudgementOnObject_at_defaultMatch.parameterNames;
  }
  ...
  @Override
  public JudgementOnObject_at_defaultMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof JudgementOnObject_at_defaultMatch)) {
        JudgementOnObject_at_defaultMatch other = (JudgementOnObject_at_defaultMatch) obj;
  ...
  @Override
  public JudgementOnObject_at_defaultQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JudgementOnObject_at_defaultMatch newEmptyMatch() {
   ...
   * 
   */
  public static JudgementOnObject_at_defaultMatch newMutableMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static JudgementOnObject_at_defaultMatch newMatch(final String pUser, final EObject pObject, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pObject, pOperation, pAccess);
  }
  
  private static final class Mutable extends JudgementOnObject_at_defaultMatch {
  ...
  private static final class Immutable extends JudgementOnObject_at_defaultMatch {
