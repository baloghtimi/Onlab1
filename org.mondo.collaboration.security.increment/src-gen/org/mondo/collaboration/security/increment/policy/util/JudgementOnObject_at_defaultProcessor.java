...
/**
 * A match processor tailored for the org.mondo.collaboration.security.increment.policy.judgementOnObject_at_default pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class JudgementOnObject_at_defaultProcessor implements IMatchProcessor<JudgementOnObject_at_defaultMatch> {
  /**
  ...
  @Override
  public void process(final JudgementOnObject_at_defaultMatch match) {
