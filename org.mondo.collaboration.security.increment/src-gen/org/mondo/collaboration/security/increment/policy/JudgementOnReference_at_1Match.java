...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.judgementOnReference_at_1 pattern,
 * to be used in conjunction with {@link JudgementOnReference_at_1Matcher}.
 * 
...
public abstract class JudgementOnReference_at_1Match extends BasePatternMatch {
  ...
  private JudgementOnReference_at_1Match(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return JudgementOnReference_at_1Match.parameterNames;
  }
  ...
  @Override
  public JudgementOnReference_at_1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof JudgementOnReference_at_1Match)) {
        JudgementOnReference_at_1Match other = (JudgementOnReference_at_1Match) obj;
  ...
  @Override
  public JudgementOnReference_at_1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JudgementOnReference_at_1Match newEmptyMatch() {
   ...
   * 
   */
  public static JudgementOnReference_at_1Match newMutableMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
   ...
   * 
   */
  public static JudgementOnReference_at_1Match newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final OperationType pOperation, final AccessibilityLevel pAccess) {
    return new Immutable(pUser, pSource, pTarget, pReference, pOperation, pAccess);
  }
  
  private static final class Mutable extends JudgementOnReference_at_1Match {
  ...
  private static final class Immutable extends JudgementOnReference_at_1Match {
