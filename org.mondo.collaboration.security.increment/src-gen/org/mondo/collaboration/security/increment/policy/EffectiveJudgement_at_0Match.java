...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.effectiveJudgement_at_0 pattern,
 * to be used in conjunction with {@link EffectiveJudgement_at_0Matcher}.
 * 
...
public abstract class EffectiveJudgement_at_0Match extends BasePatternMatch {
  ...
  private EffectiveJudgement_at_0Match(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
    this.fUser = pUser;
    this.fAsset = pAsset;
  ...
  public List<String> parameterNames() {
    return EffectiveJudgement_at_0Match.parameterNames;
  }
  ...
  @Override
  public EffectiveJudgement_at_0Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof EffectiveJudgement_at_0Match)) {
        EffectiveJudgement_at_0Match other = (EffectiveJudgement_at_0Match) obj;
  ...
  @Override
  public EffectiveJudgement_at_0QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EffectiveJudgement_at_0Match newEmptyMatch() {
   ...
   * 
   */
  public static EffectiveJudgement_at_0Match newMutableMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public static EffectiveJudgement_at_0Match newMatch(final String pUser, final EObject pAsset, final Object pOperation, final Object pAccess) {
    return new Immutable(pUser, pAsset, pOperation, pAccess);
  }
  
  private static final class Mutable extends EffectiveJudgement_at_0Match {
  ...
  private static final class Immutable extends EffectiveJudgement_at_0Match {
