...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.increment.policy.judgementOnReference_at_weak pattern,
 * to be used in conjunction with {@link JudgementOnReference_at_weakMatcher}.
 * 
...
public abstract class JudgementOnReference_at_weakMatch extends BasePatternMatch {
  ...
  private JudgementOnReference_at_weakMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess) {
    this.fUser = pUser;
  ...
  public List<String> parameterNames() {
    return JudgementOnReference_at_weakMatch.parameterNames;
  }
  ...
  @Override
  public JudgementOnReference_at_weakMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof JudgementOnReference_at_weakMatch)) {
        JudgementOnReference_at_weakMatch other = (JudgementOnReference_at_weakMatch) obj;
  ...
  @Override
  public JudgementOnReference_at_weakQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JudgementOnReference_at_weakMatch newEmptyMatch() {
   ...
   * 
   */
  public static JudgementOnReference_at_weakMatch newMutableMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess) {
   ...
   * 
   */
  public static JudgementOnReference_at_weakMatch newMatch(final String pUser, final EObject pSource, final EObject pTarget, final EReference pReference, final Object pOperation, final Object pAccess) {
    return new Immutable(pUser, pSource, pTarget, pReference, pOperation, pAccess);
  }
  
  private static final class Mutable extends JudgementOnReference_at_weakMatch {
  ...
  private static final class Immutable extends JudgementOnReference_at_weakMatch {
